...
symbols_root="${RUNNER_TEMP:-/tmp}/agent9527-symbols-${artifact_name}"
symbols_dir="${symbols_root}/agent9527-symbols-${artifact_name}"
archive_path="${archive_dir%/}/agent9527-symbols-${artifact_name}.tar.gz"
rm -rf "$symbols_root"
...
rm -f "$archive_path"
tar -C "$symbols_root" -czf "$archive_path" "agent9527-symbols-${artifact_name}"
