...
DEFAULT_CARGO_TOML = ROOT / "agent9527-rs" / "Cargo.toml"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "agent9527-rs/Cargo.toml [workspace.lints.clippy]."
        )
    )
    parser.add_argument(
        "--cargo-toml",
...
def find_workspace_lints_example_manifest() -> str | None:
    for cargo_toml in sorted((ROOT / "agent9527-rs").glob("**/Cargo.toml")):
