...
from openai_agent9527.client import Agent9527Client, _params_dict
...
from openai_agent9527.models import Notification, UnknownNotification
from openai_agent9527.types import ThreadSource
...
def test_generated_v2_bundle_has_single_shared_plan_type_definition() -> None:
    source = (ROOT / "src" / "openai_agent9527" / "generated" / "v2_all.py").read_text()
