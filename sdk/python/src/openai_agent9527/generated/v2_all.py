...
#   filename:  agent9527_app_server_protocol.v2.schemas.json
...
class Agent9527AppServerProtocolV2(BaseModel):
    pass
...
class AmazonBedrockCredentialSource(Enum):
    agent9527_managed = "agent9527Managed"
...
class Agent9527ErrorInfoValue(Enum):
...
class HttpConnectionFailedAgent9527ErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedAgent9527ErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedAgent9527ErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptsAgent9527ErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_agent9527_folder: Annotated[AbsolutePathBuf, Field(alias="dotAgent9527Folder")]
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, Agent9527 attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class RateLimitResetType(Enum):
    agent9527_rate_limits = "agent9527RateLimits"
    unknown = "unknown"
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `agent9527_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ActiveTurnNotSteerableAgent9527ErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class Agent9527ErrorInfo(
    RootModel[
        Agent9527ErrorInfoValue
        | HttpConnectionFailedAgent9527ErrorInfo
        | ResponseStreamConnectionFailedAgent9527ErrorInfo
        | ResponseStreamDisconnectedAgent9527ErrorInfo
        | ResponseTooManyFailedAttemptsAgent9527ErrorInfo
        | ActiveTurnNotSteerableAgent9527ErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    agent9527_streamlined_login: Annotated[bool | None, Field(alias="agent9527StreamlinedLogin")] = None
...
class TurnError(BaseModel):
    ...
    agent9527_error_info: Annotated[Agent9527ErrorInfo | None, Field(alias="agent9527ErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `agent9527`).",
        ),
    ] = None
...
class Turn(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this turn. Agent9527-generated turn IDs are UUIDv7.")
    ]
    items: Annotated[
...
class Thread(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this thread. Agent9527-generated thread IDs are UUIDv7.")
    ]
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, agent9527 exec, agent9527 app-server, etc.)."
        ),
    ]
