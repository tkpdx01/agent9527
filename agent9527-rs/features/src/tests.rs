...
#[test]
fn agent9527_hooks_is_legacy_alias_for_hooks() {
    assert_eq!(feature_for_key("hooks"), Some(Feature::Agent9527Hooks));
    assert_eq!(
        feature_for_key("agent9527_hooks"),
        Some(Feature::Agent9527Hooks)
    );
}
