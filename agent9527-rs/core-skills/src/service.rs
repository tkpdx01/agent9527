...
use agent9527_config::SkillsConfig;
...
impl SkillsService {
    pub fn new(agent9527_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&service.agent9527_home);
        } else if let Err(err) = install_system_skills(&service.agent9527_home) {
