...
/// Agent9527 conversation/session UUID.
...
pub type Agent9527TurnId = String;
...
/// Process/session ID returned by Agent9527's terminal runtime.
...
/// Canonical reduced graph for one Agent9527 rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Agent9527 rollout/session being observed. `trace_id`
    ...
    pub agent9527_turns: BTreeMap<Agent9527TurnId, Agent9527Turn>,
