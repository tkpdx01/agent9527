...
/// Runtime operation requested by the model, a JS code cell, or Agent9527 itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_agent9527_turn_id: Option<Agent9527TurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Agent9527 tool boundary.
    ///
    ...
    /// they describe how Agent9527 executed the request, not what the caller sent.
