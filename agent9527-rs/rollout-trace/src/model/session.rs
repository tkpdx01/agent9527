...
/// One Agent9527 thread/session participating in the rollout.
///
...
/// Provenance for a traced Agent9527 thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the Agent9527 runtime for one thread.
///
/// A Agent9527 turn groups protocol/runtime work for one thread activation.
/// It is not a user/assistant message pair; conversation belongs in
/// `ConversationItem`.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Agent9527Turn {
