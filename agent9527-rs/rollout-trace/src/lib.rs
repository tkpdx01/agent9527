//! Trace bundle format, writer, and reducer for Agent9527 rollouts.
//!
//! This crate owns the trace schema. Hot-path Agent9527 code should depend on the
...
/// Shared recorder context for inference attempts within one Agent9527 turn.
...
pub use thread::AGENT9527_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Agent9527 tool boundary.
...
/// Append-only writer used by hot-path Agent9527 instrumentation.
