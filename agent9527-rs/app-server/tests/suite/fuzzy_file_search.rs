use agent9527_app_server_protocol::FuzzyFileSearchSessionCompletedNotification;
use agent9527_app_server_protocol::FuzzyFileSearchSessionUpdatedNotification;
...
async fn test_fuzzy_file_search_sorts_and_includes_indices() -> Result<()> {
    // Prepare a temporary Agent9527 home and a separate root with test files.
