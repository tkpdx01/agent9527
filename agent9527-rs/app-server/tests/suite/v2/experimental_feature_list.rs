...
use agent9527_app_server_protocol::ExperimentalFeature;
...
use agent9527_app_server_protocol::ExperimentalFeatureStage;
...
-> Result<()> {
    let agent9527_home = TempDir::new()?;
    let project_cwd = agent9527_home.path().join("project");
