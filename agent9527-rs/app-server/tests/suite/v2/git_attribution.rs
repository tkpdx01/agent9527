...
const COMMIT_ATTRIBUTION: &str = "Co-authored-by: Agent9527 <noreply@openai.com>";
const PR_ATTRIBUTION: &str = "Generated with Agent9527.";
...
async fn git_attribution_follows_authenticated_workspace_policy() -> Result<()> {
    ...
    let mut app_server = TestAppServer::builder()
        ...
        .with_env_overrides(&[("OPENAI_API_KEY", None), ("AGENT9527_ACCESS_TOKEN", None)])
        .build()
        .await?;
