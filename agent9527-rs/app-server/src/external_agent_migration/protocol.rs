...
use agent9527_app_server_protocol::CommandMigration;
...
use agent9527_app_server_protocol::ExternalAgentConfigImportHistory;
use agent9527_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use agent9527_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
...
use agent9527_app_server_protocol::HookMigration;
use agent9527_app_server_protocol::JSONRPCErrorError;
use agent9527_app_server_protocol::McpServerMigration;
use agent9527_app_server_protocol::MigrationDetails;
use agent9527_app_server_protocol::PluginsMigration;
use agent9527_app_server_protocol::SkillMigration;
use agent9527_app_server_protocol::SubagentMigration;
use agent9527_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use agent9527_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use agent9527_external_agent_migration::ExternalAgentConfigImportSuccess;
use agent9527_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use agent9527_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use agent9527_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use agent9527_external_agent_migration::NamedMigration;
use agent9527_external_agent_migration::PluginsMigration as CorePluginsMigration;
use agent9527_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| agent9527_app_server_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
...
pub(super) fn protocol_import_history(
    record: agent9527_state::ExternalAgentConfigImportHistoryRecord,
