...
use agent9527_external_agent_migration::ExternalAgentConfigImportItemResult;
use agent9527_external_agent_migration::record_import_error;
use agent9527_external_agent_migration::sessions::CompletedExternalAgentSessionImport;
use agent9527_external_agent_migration::sessions::ExternalAgentSessionMigration;
use agent9527_external_agent_migration::sessions::ImportedExternalAgentSession;
use agent9527_external_agent_migration::sessions::ImportedSessionConnectorAttribution;
use agent9527_external_agent_migration::sessions::PendingSessionImport;
use agent9527_external_agent_migration::sessions::SessionMetadataMode;
use agent9527_external_agent_migration::sessions::detect_imported_cla_session_connectors;
use agent9527_external_agent_migration::sessions::prepare_validated_session_import_with_metadata_mode;
use agent9527_external_agent_migration::sessions::record_completed_session_imports;
...
impl ExternalAgentSessionImporter {
    ...
    pub(super) async fn import_sessions(
        ...
        let completed_imports = completed_imports
            ...
            .collect();
        if let Err(err) = record_completed_session_imports(&self.agent9527_home, completed_imports)
        {
            record_import_error(
                &mut item_result,
    ...
    async fn persist_session(
        ...
        let create_params = CreateThreadParams {
            ...
            source: source.clone(),
            thread_source: None,
            originator: agent9527_login::default_client::originator().value,
