...
use agent9527_analytics::ExternalAgentConfigImportCompletedInput;
use agent9527_analytics::ExternalAgentConfigImportFailureInput;
...
use agent9527_app_server_protocol::ExternalAgentConfigImportHistoryRecordParams;
use agent9527_app_server_protocol::ExternalAgentConfigImportHistoryRecordResponse;
use agent9527_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
...
use agent9527_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
...
use agent9527_external_agent_migration::ExternalAgentConfigDetectOptions;
use agent9527_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use agent9527_external_agent_migration::ExternalAgentConfigImportOutcome as CoreImportOutcome;
use agent9527_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use agent9527_external_agent_migration::ExternalAgentConfigService;
use agent9527_external_agent_migration::ExternalAgentSessionImportLimits;
use agent9527_external_agent_migration::PluginImportOutcome;
use agent9527_external_agent_migration::record_import_error;
use agent9527_external_agent_migration::sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use agent9527_external_agent_migration::sessions::read_imported_connector_candidates;
use agent9527_features::Feature;
use agent9527_rollout::StateDbHandle;
use agent9527_state::ExternalAgentConfigImportFailureRecord;
use agent9527_state::ExternalAgentConfigImportSuccessRecord;
...
pub(crate) struct ExternalAgentConfigRequestProcessorArgs {
    ...
    pub(crate) agent9527_home: PathBuf,
}
...
impl ExternalAgentConfigRequestProcessor {
    ...
    pub(crate) async fn read_import_histories(
        ...
        let connectors =
            read_imported_connector_candidates(self.migration_service.agent9527_home())
                .map_err(|err| {
