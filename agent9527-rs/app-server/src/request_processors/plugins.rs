...
use agent9527_analytics::PluginInstallSource;
use agent9527_app_server_protocol::PluginAvailability;
use agent9527_app_server_protocol::PluginInstallPolicy;
use agent9527_app_server_protocol::PluginSharePrincipalRole;
use agent9527_app_server_protocol::PluginShareTargetRole;
use agent9527_config::types::McpServerConfig;
use agent9527_core_plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use agent9527_core_plugins::PluginListBackgroundTaskOptions;
use agent9527_core_plugins::is_openai_curated_marketplace_name;
use agent9527_core_plugins::remote::REMOTE_CREATED_BY_ME_MARKETPLACE_NAME;
use agent9527_core_plugins::remote::REMOTE_GLOBAL_MARKETPLACE_NAME;
use agent9527_core_plugins::remote::REMOTE_WORKSPACE_MARKETPLACE_NAME;
use agent9527_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_MARKETPLACE_NAME;
use agent9527_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_PRIVATE_MARKETPLACE_NAME;
use agent9527_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_UNLISTED_MARKETPLACE_NAME;
use agent9527_core_plugins::remote::RemoteAppTemplateUnavailableReason;
use agent9527_core_plugins::remote::RemotePluginCatalogCacheMode;
use agent9527_core_plugins::remote::RemotePluginScope;
use agent9527_core_plugins::remote::is_valid_remote_plugin_id;
use agent9527_core_plugins::remote::validate_remote_plugin_id;
use agent9527_core_plugins::remote_bundle::RemotePluginBundleInstallError;
use agent9527_mcp::McpOAuthLoginSupport;
use agent9527_mcp::oauth_login_support;
use agent9527_mcp::should_retry_without_scopes;
use agent9527_plugin::PluginId;
use agent9527_plugin::PluginTelemetryMetadata;
use agent9527_protocol::auth::AuthMode as DomainAuthMode;
use agent9527_rmcp_client::perform_oauth_login_silent;
...
pub(crate) struct PluginRequestProcessor {
    ...
    on_effective_plugins_changed:
        Arc<dyn Fn(agent9527_core_plugins::EffectivePluginsChange) + Send + Sync>,
}

fn plugin_skills_to_info(
    skills: &[agent9527_core::skills::SkillMetadata],
    ...
    skills
        ...
        .map(|skill| SkillSummary {
            ...
            interface: skill.interface.clone().map(|interface| {
                agent9527_app_server_protocol::SkillInterface {
...
fn load_shared_plugin_ids_by_local_path(
    ...
    agent9527_core_plugins::remote::load_plugin_share_remote_ids_by_local_path(
...
fn convert_configured_marketplace_plugin_to_plugin_summary(
    plugin: agent9527_core_plugins::ConfiguredMarketplacePlugin,
    shared_plugin_ids_by_local_path: &std::collections::BTreeMap<AbsolutePathBuf, String>,
) -> PluginSummary {
...
) -> agent9527_core_plugins::remote::RemotePluginShareDiscoverability {
    match discoverability {
        PluginShareDiscoverability::Listed => {
            agent9527_core_plugins::remote::RemotePluginShareDiscoverability::Listed
        }
        PluginShareDiscoverability::Unlisted => {
            agent9527_core_plugins::remote::RemotePluginShareDiscoverability::Unlisted
        }
        PluginShareDiscoverability::Private => {
            agent9527_core_plugins::remote::RemotePluginShareDiscoverability::Private
        }
    }
}
...
) -> agent9527_core_plugins::remote::RemotePluginShareUpdateDiscoverability {
    match discoverability {
        PluginShareUpdateDiscoverability::Listed => {
            agent9527_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Listed
        }
        PluginShareUpdateDiscoverability::Unlisted => {
            agent9527_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Unlisted
        }
        PluginShareUpdateDiscoverability::Private => {
            agent9527_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Private
        }
    }
}
...
) -> agent9527_core_plugins::remote::RemotePluginShareTargetRole {
    match role {
        PluginShareTargetRole::Reader => {
            agent9527_core_plugins::remote::RemotePluginShareTargetRole::Reader
        }
        PluginShareTargetRole::Editor => {
            agent9527_core_plugins::remote::RemotePluginShareTargetRole::Editor
        }
    }
}

fn plugin_share_principal_role_from_remote(
    role: agent9527_core_plugins::remote::RemotePluginSharePrincipalRole,
) -> PluginSharePrincipalRole {
    match role {
        agent9527_core_plugins::remote::RemotePluginSharePrincipalRole::Reader => {
            PluginSharePrincipalRole::Reader
        }
        agent9527_core_plugins::remote::RemotePluginSharePrincipalRole::Editor => {
            PluginSharePrincipalRole::Editor
        }
        agent9527_core_plugins::remote::RemotePluginSharePrincipalRole::Owner => {
...
) -> Vec<agent9527_core_plugins::remote::RemotePluginShareTarget> {
    targets
        .into_iter()
        .map(
            |target| agent9527_core_plugins::remote::RemotePluginShareTarget {
                principal_type: match target.principal_type {
                    PluginSharePrincipalType::User => {
                        agent9527_core_plugins::remote::RemotePluginSharePrincipalType::User
                    }
                    PluginSharePrincipalType::Group => {
                        agent9527_core_plugins::remote::RemotePluginSharePrincipalType::Group
                    }
                    PluginSharePrincipalType::Workspace => {
                        agent9527_core_plugins::remote::RemotePluginSharePrincipalType::Workspace
                    }
                },
...
fn plugin_share_principal_from_remote(
    principal: agent9527_core_plugins::remote::RemotePluginSharePrincipal,
...
impl PluginRequestProcessor {
    pub(crate) fn new(
        ...
        on_effective_plugins_changed: Arc<
            dyn Fn(agent9527_core_plugins::EffectivePluginsChange) + Send + Sync,
        >,
    ) -> Self {
        Self {
            auth_manager,
    ...
    async fn workspace_agent9527_plugins_enabled(
        &self,
        config: &Config,
        auth: Option<&Agent9527Auth>,
    ) -> bool {
        match workspace_settings::agent9527_plugins_enabled_for_workspace(
            config,
            auth,
        ...
        .await
        {
            ...
            Err(err) => {
                warn!(
                    "failed to fetch workspace Agent9527 plugins setting; allowing Agent9527 plugins: {err:#}"
                );
                true
            }
        }
    ...
    async fn plugin_list_response(
        ...
        if !self
            .workspace_agent9527_plugins_enabled(&config, auth.as_ref())
            .await
        {
            return Ok(empty_response());
        }
        let auth_mode = auth.as_ref().map(Agent9527Auth::api_auth_mode);
        ...
        let use_remote_global_catalog =
            include_global_remote && auth_mode.is_some_and(DomainAuthMode::uses_agent9527_backend);
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                Ok::<
                    (
                        ...
                        Vec<agent9527_app_server_protocol::MarketplaceLoadErrorInfo>,
                    ),
                    MarketplaceError,
                >((
                    outcome
                    ...
                    outcome
                        ...
                        .into_iter()
                        .map(
                            |err| agent9527_app_server_protocol::MarketplaceLoadErrorInfo {
        ...
        if include_vertical && !config.features.enabled(Feature::RemotePlugin) {
            match agent9527_core_plugins::remote::fetch_openai_curated_remote_collection_marketplace(
        ...
        if !remote_sources.is_empty() {
            match agent9527_core_plugins::remote::fetch_remote_marketplaces(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_sources,
                /*catalog_cache_root*/ Some(config.agent9527_home.as_path()),
    ...
    async fn plugin_installed_response(
        ...
        plugins_manager.set_auth_mode(auth.as_ref().map(Agent9527Auth::api_auth_mode));
    ...
    async fn load_local_installed_and_suggested_plugins(
        &self,
        plugins_manager: Arc<agent9527_core_plugins::PluginsManager>,
        config: &Config,
        plugins_input: &agent9527_core_plugins::PluginsConfigInput,
        ...
        let plugin = match read_source {
            Ok(marketplace_path) => {
                ...
                let share_context = match share_context {
                    Some(context) => {
                        let remote_plugin_service_config = remote_plugin_service_config(&config);
                        match agent9527_core_plugins::remote::fetch_remote_plugin_share_context(
                            &remote_plugin_service_config,
                            auth.as_ref(),
                ...
                PluginDetail {
                    ...
                    hooks: outcome
                        ...
                        .hooks
                        .into_iter()
                        .map(|hook| agent9527_app_server_protocol::PluginHookSummary {
                            key: hook.key,
            ...
            Err(remote_marketplace_name) => {
                ...
                let remote_detail = agent9527_core_plugins::remote::fetch_remote_plugin_detail(
                    &remote_plugin_service_config,
                    auth.as_ref(),
                    &remote_marketplace_name,
                    &plugin_name,
                ...
                let plugin_apps = remote_detail
                    ...
                    .iter()
                    .cloned()
                    .map(agent9527_plugin::AppConnectorId)
                    .collect::<Vec<_>>();
    ...
    async fn plugin_skill_read_response(
        ...
        let auth = self.auth_manager.auth().await;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let remote_skill_detail = agent9527_core_plugins::remote::fetch_remote_plugin_skill_detail(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_marketplace_name,
            &remote_plugin_id,
    ...
    async fn plugin_share_save_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let access_policy = agent9527_core_plugins::remote::RemotePluginShareAccessPolicy {
        ...
        let result = agent9527_core_plugins::remote::save_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.agent9527_home.as_path(),
            &plugin_path,
        ...
        agent9527_core_plugins::remote::invalidate_cached_remote_plugin_catalog_scopes(
            config.agent9527_home.as_path(),
            &remote_plugin_service_config,
            auth.as_ref(),
    ...
    async fn plugin_share_update_targets_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = agent9527_core_plugins::remote::update_remote_plugin_share_targets(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_plugin_id,
    ...
    async fn plugin_share_list_response(
        ...
        let (config, auth) = self.load_plugin_share_config_and_auth().await?;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let data = agent9527_core_plugins::remote::list_remote_plugin_shares(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.agent9527_home.as_path(),
        )
    ...
    async fn plugin_share_checkout_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = agent9527_core_plugins::remote::checkout_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.agent9527_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_share_delete_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        agent9527_core_plugins::remote::delete_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.agent9527_home.as_path(),
            &remote_plugin_id,
    ...
    async fn load_plugin_share_config_and_auth(
        &self,
    ) -> Result<(Config, Option<Agent9527Auth>), JSONRPCErrorError> {
        let config = self.load_latest_config(/*fallback_cwd*/ None).await?;
        if !config.features.enabled(Feature::Plugins) {
    ...
    async fn plugin_install_response(
        ...
        {
            return Err(invalid_request(
                "Agent9527 plugins are disabled for this workspace",
            ));
        }
        ...
        let plugin_mcp_servers = load_plugin_mcp_servers(
            ...
            auth.as_ref().map(Agent9527Auth::auth_mode),
        )
        .await;
    ...
    async fn remote_plugin_install_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let remote_detail =
            agent9527_core_plugins::remote::fetch_remote_plugin_detail_with_download_urls(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_marketplace_name,
                &remote_plugin_id,
        ...
        let _remote_plugin_cache_mutation =
            agent9527_core_plugins::remote::mark_remote_plugin_cache_mutation_in_flight(
                config.agent9527_home.as_path(),
                &actual_remote_marketplace_name,
                &remote_plugin_name,
            );
        let validated_bundle =
            agent9527_core_plugins::remote_bundle::validate_remote_plugin_bundle(
                &remote_plugin_id,
                &actual_remote_marketplace_name,
                &remote_plugin_name,
        ...
        let result =
            agent9527_core_plugins::remote_bundle::download_and_install_remote_plugin_bundle(
                &remote_plugin_service_config,
        ...
        let install_result = agent9527_core_plugins::remote::install_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            &actual_remote_marketplace_name,
            &remote_plugin_id,
        ...
        let is_chatgpt_auth = auth.as_ref().is_some_and(Agent9527Auth::is_chatgpt_auth);
    ...
    async fn plugin_apps_needing_auth_for_install(
        ...
        auth: Option<&Agent9527Auth>,
        plugin_id: &str,
        plugin_app_declarations: &[agent9527_plugin::AppDeclaration],
    ) -> Vec<AppSummary> {
        if plugin_app_declarations.is_empty()
            || !config
                .features
                .apps_enabled_for_auth(auth.is_some_and(Agent9527Auth::is_chatgpt_auth))
        {
            return Vec::new();
        }

        let plugin_apps =
            agent9527_plugin::app_connector_ids_from_declarations(plugin_app_declarations);
        ...
        let (accessible_connectors, agent9527_apps_ready) = match accessible_connectors_result {
            Ok(status) => (status.connectors, status.agent9527_apps_ready),
            Err(err) => {
                warn!(
                    plugin = plugin_id,
        ...
        if !agent9527_apps_ready {
            warn!(
                plugin = plugin_id,
                "agent9527_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
            );
            return Vec::new();
        }
    ...
    async fn plugin_uninstall_response(
        ...
        if agent9527_plugin::PluginId::parse(&plugin_id).is_err()
    ...
    async fn remote_plugin_uninstall_response(
        ...
        let uninstall_target =
            agent9527_core_plugins::remote::resolve_remote_plugin_uninstall_target(
                &remote_plugin_service_config,
                auth.as_ref(),
                &plugin_id,
            )
        ...
        let uninstall_result = agent9527_core_plugins::remote::uninstall_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.agent9527_home.to_path_buf(),
            uninstall_target,
...
async fn load_plugin_app_summaries(
    config: &Config,
    auth: Option<&Agent9527Auth>,
    plugin_apps: &[agent9527_plugin::AppConnectorId],
    ...
    if let Some(auth) = auth.filter(|auth| {
        config
            .features
            .apps_enabled_for_auth(auth.uses_agent9527_backend())
    }) {
        metadata_by_id.extend(
            agent9527_connectors::ConnectorMetadataStore::new(
                config.chatgpt_base_url.clone(),
                auth.get_account_id(),
    ...
    app_ids
        ...
        .map(|app_id| {
            ...
            AppSummary {
                install_url: Some(agent9527_connectors::metadata::connector_install_url(
                    &name, &app_id,
                )),
                id: app_id,
                name,
...
fn plugin_app_category_by_id_from_value(value: &serde_json::Value) -> HashMap<String, String> {
    agent9527_core_plugins::loader::plugin_app_declarations_from_value(value)
        .into_iter()
...
fn remote_plugin_share_discoverability_to_info(
    discoverability: agent9527_core_plugins::remote::RemotePluginShareDiscoverability,
...
fn remote_plugin_bundle_install_error_to_jsonrpc(
    err: agent9527_core_plugins::remote_bundle::RemotePluginBundleInstallError,
) -> JSONRPCErrorError {
