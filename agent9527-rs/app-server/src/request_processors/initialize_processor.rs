...
use agent9527_login::default_client::SetOriginatorError;
...
const NON_ORIGINATING_CLIENT_NAMES: &[&str] = &["agent9527_app_server_daemon", "agent9527-backend"];
            ...
            if let Err(error) = set_default_originator(originator.clone()) {
                match error {
                    ...
                    SetOriginatorError::AlreadyInitialized => {
                        ...
                        // TODO(owen): Once we remove support for AGENT9527_INTERNAL_ORIGINATOR_OVERRIDE,
