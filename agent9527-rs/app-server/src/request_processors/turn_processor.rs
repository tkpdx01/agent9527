use super::*;
use agent9527_agent_extension::AgentInvocation;
use agent9527_agent_extension::AgentRun;
use agent9527_agent_extension::AgentRunner;
...
use agent9527_protocol::protocol::AdditionalContextEntry as CoreAdditionalContextEntry;
use agent9527_protocol::protocol::AdditionalContextKind as CoreAdditionalContextKind;
...
use agent9527_skills::system_cache_root_dir;
...
struct ThreadSettingsBuildParams {
    ...
    sandbox_policy: Option<agent9527_app_server_protocol::SandboxPolicy>,
...
impl TurnRequestProcessor {
    ...
    fn review_request_from_target(
        ...
        let hint = agent9527_core::review_prompts::user_facing_hint(&core_target);
    ...
    async fn turn_start_inner(
        ...
        if turn_has_input {
            ...
            agent9527_memories_write::start_memories_startup_task(
    ...
    async fn build_thread_settings_overrides(
    ...
    ) -> Result<agent9527_protocol::protocol::ThreadSettingsOverrides, JSONRPCErrorError> {
        ...
        let approval_policy =
            approval_policy.map(agent9527_app_server_protocol::AskForApproval::to_core);
        let approvals_reviewer =
            approvals_reviewer.map(agent9527_app_server_protocol::ApprovalsReviewer::to_core);
        ...
        let (permission_profile, active_permission_profile, profile_workspace_roots) =
            if let Some(permissions) = permissions {
                ...
                let overrides = ConfigOverrides {
                    ...
                    agent9527_linux_sandbox_exe: self
                        .arg0_paths
        ...
        if has_any_overrides {
            thread
                .preview_thread_settings_overrides(Agent9527ThreadSettingsOverrides {
        ...
        Ok(agent9527_protocol::protocol::ThreadSettingsOverrides {
            environments,
    ...
    async fn thread_settings_update_inner(
        ...
        if thread_settings != agent9527_protocol::protocol::ThreadSettingsOverrides::default() {
            self.submit_core_op(
                request_id,
                thread.as_ref(),
                ...
                let (message, data, error_type) = match err {
                    ...
                    SteerInputError::ActiveTurnNotSteerable { turn_kind } => {
                        let (message, turn_steer_error) = match turn_kind {
                            agent9527_protocol::protocol::NonSteerableTurnKind::Review => (
                                "cannot steer a review turn".to_string(),
                                TurnSteerRequestError::NonSteerableReview,
                            ),
                            agent9527_protocol::protocol::NonSteerableTurnKind::Compact => (
    ...
    async fn prepare_realtime_conversation_thread(
        ...
        request_id: &ConnectionRequestId,
        thread_id: &str,
    ) -> Result<Option<(ThreadId, Arc<Agent9527Thread>)>, JSONRPCErrorError> {
        ...
        self.submit_core_op(
            ...
            Op::RealtimeConversationStart(ConversationStartParams {
                ...
                flush_transcript_tail_on_session_end: params
                    ...
                    .unwrap_or(false),
                agent9527_responses_as_items: params.agent9527_responses_as_items.unwrap_or(false),
                agent9527_response_item_prefix: params.agent9527_response_item_prefix,
                agent9527_response_handoff_mode: params
    ...
    async fn start_inline_review(
        &self,
        request_id: &ConnectionRequestId,
        parent_thread: Arc<Agent9527Thread>,
    ...
    async fn start_detached_review(
        ...
        if matches!(
            ...
            agent9527_protocol::protocol::ThreadHistoryMode::Paginated
        ) {
            return Err(invalid_request(
    ...
    async fn review_start_inner(
        ...
        match delivery.unwrap_or(ApiReviewDelivery::Inline).to_core() {
            ...
            CoreReviewDelivery::Detached => {
                let review_skill_path = system_cache_root_dir(&self.config.agent9527_home)
                    .join("review-agent")
                    .join("SKILL.md");
                let prompt = format!(
