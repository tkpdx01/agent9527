...
use agent9527_otel::span_w3c_trace_context;
...
pub(crate) use agent9527_app_server_transport::OutgoingError;
pub(crate) use agent9527_app_server_transport::OutgoingMessage;
pub(crate) use agent9527_app_server_transport::OutgoingResponse;
...
mod tests {
    ...
    use agent9527_app_server_protocol::ApplyPatchApprovalParams;
    ...
    fn verify_model_rerouted_notification_serialization() {
        let notification = ServerNotification::ModelRerouted(ModelReroutedNotification {
            ...
            from_model: "gpt-5.3-agent9527".to_string(),
    ...
    async fn send_response_routes_to_target_connection() {
        ...
        let outgoing =
            OutgoingMessageSender::new(tx, agent9527_analytics::AnalyticsEventsClient::disabled());
        ...
        outgoing
            .send_response(
                ...
                ClientResponsePayload::ThreadArchive(
                    agent9527_app_server_protocol::ThreadArchiveResponse {},
                ),
            )
            .await;
