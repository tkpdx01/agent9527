...
use agent9527_app_server_protocol::Config as ApiConfig;
...
use agent9527_config::ShellEnvironmentPolicyFilterRepresentation;
use agent9527_config::config_toml::ConfigToml;
use agent9527_config::merge_toml_values;
use agent9527_config::shell_environment_filter_entry;
use agent9527_config::validate_shell_environment_policy_filter_config;
use agent9527_core::config::deserialize_config_toml_with_base;
use agent9527_core::config::edit::ConfigEdit;
use agent9527_core::config::edit::ConfigEditsBuilder;
use agent9527_core::config::validate_feature_requirements_for_config_toml;
use agent9527_core::path_utils;
use agent9527_core::path_utils::SymlinkWritePaths;
use agent9527_core::path_utils::resolve_symlink_write_paths;
use agent9527_core::path_utils::write_atomically;
...
impl ConfigManager {
    ...
    async fn apply_edits(
        ...
        let user_config_toml =
            deserialize_config_toml_with_base(user_config.clone(), self.agent9527_home()).map_err(
                |err| {
                    ConfigManagerError::write(
                        ConfigWriteErrorCode::ConfigValidationError,
                        format!("Invalid configuration: {err}"),
    ...
    /// include any in-repo .agent9527/ folders because there is no cwd/project root
