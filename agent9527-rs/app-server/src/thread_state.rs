...
use agent9527_file_watcher::WatchRegistration;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: agent9527_app_server_protocol::Thread,
    ...
    pub(crate) initial_turns_page:
        Option<agent9527_app_server_protocol::ThreadResumeInitialTurnsPageParams>,
    pub(crate) paginated_turns: Option<Vec<Turn>>,
    pub(crate) paginated_initial_turns_page: Option<agent9527_app_server_protocol::TurnsPage>,
    pub(crate) paginated_initial_turns_page_with_active_slot:
        Option<agent9527_app_server_protocol::TurnsPage>,
    pub(crate) resume_cursor_store: Option<Arc<dyn agent9527_thread_store::ThreadStore>>,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<Agent9527Thread>>,
    watch_registration: WatchRegistration,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<Agent9527Thread>) -> bool {
