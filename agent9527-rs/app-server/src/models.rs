...
use agent9527_app_server_protocol::Model;
use agent9527_app_server_protocol::ModelServiceTier;
use agent9527_app_server_protocol::ModelUpgradeInfo;
use agent9527_app_server_protocol::ReasoningEffortOption;
