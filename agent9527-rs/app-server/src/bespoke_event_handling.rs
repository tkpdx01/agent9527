...
use agent9527_app_server_protocol::AccountRateLimitsUpdatedNotification;
use agent9527_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use agent9527_app_server_protocol::Agent9527ErrorInfo as V2Agent9527ErrorInfo;
use agent9527_app_server_protocol::CommandAction as V2ParsedCommand;
...
use agent9527_app_server_protocol::DynamicToolCallParams;
use agent9527_app_server_protocol::EnvironmentConnectionNotification;
use agent9527_app_server_protocol::ErrorNotification;
use agent9527_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use agent9527_app_server_protocol::FileChangeApprovalDecision;
use agent9527_app_server_protocol::FileChangeRequestApprovalParams;
use agent9527_app_server_protocol::FileChangeRequestApprovalResponse;
use agent9527_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use agent9527_app_server_protocol::GuardianWarningNotification;
use agent9527_app_server_protocol::HookCompletedNotification;
use agent9527_app_server_protocol::HookStartedNotification;
...
use agent9527_app_server_protocol::McpServerElicitationRequestParams;
use agent9527_app_server_protocol::McpServerElicitationRequestResponse;
use agent9527_app_server_protocol::McpServerStartupState;
use agent9527_app_server_protocol::McpServerStatusUpdatedNotification;
use agent9527_app_server_protocol::ModelReroutedNotification;
use agent9527_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use agent9527_app_server_protocol::ModelVerificationNotification;
use agent9527_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use agent9527_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use agent9527_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use agent9527_app_server_protocol::PermissionsRequestApprovalParams;
use agent9527_app_server_protocol::PermissionsRequestApprovalResponse;
use agent9527_app_server_protocol::RawResponseCompletedNotification;
use agent9527_app_server_protocol::RawResponseItemCompletedNotification;
...
use agent9527_app_server_protocol::ThreadRealtimeClosedNotification;
use agent9527_app_server_protocol::ThreadRealtimeErrorNotification;
use agent9527_app_server_protocol::ThreadRealtimeItemAddedNotification;
use agent9527_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use agent9527_app_server_protocol::ThreadRealtimeSdpNotification;
use agent9527_app_server_protocol::ThreadRealtimeStartedNotification;
use agent9527_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use agent9527_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use agent9527_app_server_protocol::ThreadRollbackResponse;
use agent9527_app_server_protocol::ThreadSettingsUpdatedNotification;
use agent9527_app_server_protocol::ThreadStatus;
use agent9527_app_server_protocol::ThreadTokenUsage;
use agent9527_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use agent9527_app_server_protocol::ToolRequestUserInputOption;
use agent9527_app_server_protocol::ToolRequestUserInputParams;
use agent9527_app_server_protocol::ToolRequestUserInputQuestion;
...
use agent9527_app_server_protocol::TurnModerationMetadataNotification;
use agent9527_app_server_protocol::TurnPlanStep;
use agent9527_app_server_protocol::TurnPlanUpdatedNotification;
...
use agent9527_app_server_protocol::build_item_from_guardian_event;
use agent9527_app_server_protocol::guardian_auto_approval_review_notification;
use agent9527_app_server_protocol::item_event_to_server_notification;
use agent9527_core::Agent9527Thread;
use agent9527_core::ThreadManager;
use agent9527_protocol::ThreadId;
use agent9527_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use agent9527_protocol::items::TurnItem as CoreTurnItem;
use agent9527_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use agent9527_protocol::plan_tool::UpdatePlanArgs;
use agent9527_protocol::protocol::Agent9527ErrorInfo as CoreAgent9527ErrorInfo;
use agent9527_protocol::protocol::Event;
use agent9527_protocol::protocol::EventMsg;
use agent9527_protocol::protocol::ExecApprovalRequestEvent;
use agent9527_protocol::protocol::Op;
use agent9527_protocol::protocol::RealtimeEvent;
use agent9527_protocol::protocol::ReviewDecision;
use agent9527_protocol::protocol::SubAgentActivityKind;
...
use agent9527_protocol::protocol::TurnDiffEvent;
...
use agent9527_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use agent9527_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use agent9527_sandboxing::policy_transforms::intersect_permission_profiles;
use agent9527_shell_command::parse_command::shlex_join;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    conversation: Arc<Agent9527Thread>,
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                agent9527_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                agent9527_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                agent9527_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                agent9527_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status
                == agent9527_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                agent9527_protocol::protocol::GuardianAssessmentStatus::Denied
                | agent9527_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                agent9527_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                agent9527_protocol::protocol::GuardianAssessmentStatus::InProgress
                | agent9527_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: agent9527_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let agent9527_error_info = ev.agent9527_error_info.clone();
            ...
            if matches!(
                agent9527_error_info,
                Some(CoreAgent9527ErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                agent9527_error_info: ev.agent9527_error_info.map(V2Agent9527ErrorInfo::from),
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: agent9527_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: agent9527_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: agent9527_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<Agent9527Thread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: agent9527_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            agent9527_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use agent9527_app_server_protocol::AutoReviewDecisionSource;
    ...
    use agent9527_app_server_protocol::TurnPlanStepStatus;
    use agent9527_login::Agent9527Auth;
    use agent9527_protocol::AgentPath;
    use agent9527_protocol::items::AgentMessageContent as CoreAgentMessageContent;
    use agent9527_protocol::items::AgentMessageItem as CoreAgentMessageItem;
    use agent9527_protocol::items::DynamicToolCallItem;
    use agent9527_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use agent9527_protocol::items::SubAgentActivityItem;
    use agent9527_protocol::items::TurnItem as CoreTurnItem;
    use agent9527_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    ...
    use agent9527_protocol::plan_tool::PlanItemArg;
    use agent9527_protocol::plan_tool::StepStatus;
    use agent9527_protocol::protocol::AgentMessageEvent;
    use agent9527_protocol::protocol::AskForApproval;
    use agent9527_protocol::protocol::CreditsSnapshot;
    use agent9527_protocol::protocol::EventMsg;
    use agent9527_protocol::protocol::GuardianAssessmentEvent;
    use agent9527_protocol::protocol::GuardianAssessmentStatus;
    use agent9527_protocol::protocol::ItemCompletedEvent;
    use agent9527_protocol::protocol::ItemStartedEvent;
    ...
    use agent9527_thread_store::StoredThreadHistory;
    use agent9527_utils_absolute_path::AbsolutePathBuf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: agent9527_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(agent9527_protocol::protocol::GuardianRiskLevel::Low),
                Some(agent9527_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(agent9527_protocol::protocol::GuardianRiskLevel::High),
                Some(agent9527_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(agent9527_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = agent9527_protocol::protocol::GuardianAssessmentAction::Command {
            source: agent9527_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: agent9527_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: agent9527_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(agent9527_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(
                    agent9527_protocol::protocol::GuardianUserAuthorization::Low,
                ),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    agent9527_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(agent9527_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(agent9527_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = agent9527_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: agent9527_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: agent9527_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&agent9527_home).await;
        let thread_manager = Arc::new(
            agent9527_core::test_support::thread_manager_with_models_provider_and_home(
                Agent9527Auth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.agent9527_home.to_path_buf(),
                Arc::new(agent9527_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let agent9527_core::NewThread {
            thread_id: conversation_id,
            thread: conversation,
            ..
        } = thread_manager
            .start_thread(agent9527_core::StartThreadOptions::new(config.clone()))
            .await?;
        let thread_state = new_thread_state();
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                agent9527_error_info: Some(V2Agent9527ErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(agent9527_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(agent9527_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(agent9527_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
    ...
    async fn interrupted_subagent_activity_removes_missing_thread_watch() -> Result<()> {
        ...
        let agent9527_core::NewThread {
            ...
            .start_thread(agent9527_core::StartThreadOptions::new(config))
            .await?;
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: agent9527_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                agent9527_error_info: Some(V2Agent9527ErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            ServerNotification::AccountRateLimitsUpdated(payload) => {
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("agent9527"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                agent9527_error_info: Some(V2Agent9527ErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
