//! Write-path implementation for Agent9527 memories.
//!
...
mod guard_limits {
    pub(super) const AGENT9527_LIMIT_ID: &str = "agent9527";
}
...
mod stage_one {
    pub(super) const REASONING_EFFORT: agent9527_protocol::openai_models::ReasoningEffort =
        agent9527_protocol::openai_models::ReasoningEffort::Low;
...
mod stage_two {
    pub(super) const REASONING_EFFORT: agent9527_protocol::openai_models::ReasoningEffort =
        agent9527_protocol::openai_models::ReasoningEffort::Medium;
    pub(super) const JOB_LEASE_SECONDS: i64 = 3_600;
    pub(super) const JOB_RETRY_DELAY_SECONDS: i64 = 3_600;
