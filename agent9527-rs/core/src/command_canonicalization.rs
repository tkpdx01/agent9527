...
use agent9527_shell_command::powershell::extract_powershell_command;

const CANONICAL_BASH_SCRIPT_PREFIX: &str = "__agent9527_shell_script__";
const CANONICAL_POWERSHELL_SCRIPT_PREFIX: &str = "__agent9527_powershell_script__";
