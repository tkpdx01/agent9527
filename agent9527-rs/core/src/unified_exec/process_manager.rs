...
use agent9527_protocol::protocol::TerminalInteractionEvent;
...
impl UnifiedExecProcessManager {
    ...
    pub(crate) async fn open_session_with_prepared_exec_env(
        ...
        let windows_sandbox =
            if request.sandbox == agent9527_sandboxing::SandboxType::WindowsRestrictedToken {
                Some(agent9527_sandboxing::WindowsSandboxSpawnRequest {
        ...
        let spawn_result =
            agent9527_sandboxing::spawn_process(agent9527_sandboxing::SpawnRequest {
    ...
    pub(super) async fn open_session_with_sandbox(
        ...
        orchestrator
            ...
            .map_err(|err| match err {
                ToolError::Agent9527(err) => match err.details() {
