...
) -> agent9527_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => agent9527_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => agent9527_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => agent9527_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => agent9527_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => agent9527_tools::ToolUserShellType::Cmd,
    }
}
