...
use agent9527_tools::LoadableToolSpec;
use agent9527_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use agent9527_tools::TOOL_SEARCH_TOOL_NAME;
use agent9527_tools::ToolName;
use agent9527_tools::ToolSearchEntry;
use agent9527_tools::ToolSearchInfo;
use agent9527_tools::ToolSpec;
use agent9527_tools::coalesce_loadable_tool_specs;
use bm25::Document;
use bm25::Language;
...
mod tests {
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        let dynamic_namespace = DynamicToolNamespaceSpec {
            ...
            description: "Tools in the agent9527_app namespace.".to_string(),
            tools: Vec::new(),
        };
