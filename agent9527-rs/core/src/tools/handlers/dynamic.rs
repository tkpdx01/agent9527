...
use agent9527_protocol::items::DynamicToolCallStatus;
...
use agent9527_tools::ToolSearchSourceInfo;
use agent9527_tools::ToolSpec;
use agent9527_tools::default_namespace_description;
use agent9527_tools::dynamic_tool_to_responses_api_tool;
    ...
    fn search_info(&self) -> Option<ToolSearchInfo> {
        ToolSearchInfo::from_tool_spec(
            ...
            Some(ToolSearchSourceInfo {
                ...
                description: Some("Tools provided by the current Agent9527 thread.".to_string()),
            }),
        )
    }
