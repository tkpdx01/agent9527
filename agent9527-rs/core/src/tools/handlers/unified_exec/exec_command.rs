...
use agent9527_otel::TOOL_CALL_UNIFIED_EXEC_METRIC;
...
use agent9527_shell_command::shell_detect::detect_shell_type;
...
impl ExecCommandHandler {
    async fn handle_call(
        ...
        let command_for_display = agent9527_shell_command::parse_command::shlex_join(&command);
        ...
        if effective_additional_permissions
            ...
            && !matches!(
                ...
                agent9527_protocol::protocol::AskForApproval::OnRequest
            )
        {
