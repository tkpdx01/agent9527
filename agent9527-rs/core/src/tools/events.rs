...
use agent9527_apply_patch::AppliedPatchDelta;
...
use agent9527_protocol::items::CommandExecutionStatus;
...
impl ToolEmitter {
    ...
    pub async fn finish(
        ...
        let (event, result) = match out {
            ...
            Err(ToolError::Agent9527(err)) => match err.details() {
...
mod tests {
    ...
    async fn assert_failed_apply_patch_tracks_committed_delta(
        ...
        let delta = agent9527_apply_patch::apply_patch(
    ...
    async fn denied_apply_patch_tracks_committed_delta() {
        ...
        assert_failed_apply_patch_tracks_committed_delta(
            Err(ToolError::Agent9527(Agent9527Err::Sandbox(
                SandboxErr::Denied {
