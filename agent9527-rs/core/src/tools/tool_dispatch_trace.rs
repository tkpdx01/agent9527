...
//!
//! `agent9527-rollout-trace` owns the event schema and writer behavior. This module
...
use agent9527_rollout_trace::ToolDispatchResult;
use agent9527_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        agent9527_turn_id: invocation.turn.sub_id.clone(),
