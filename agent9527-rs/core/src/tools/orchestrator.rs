...
impl ToolOrchestrator {
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        match first_result {
            ...
            Err(ToolError::Agent9527(Agent9527Err::Sandbox(SandboxErr::Denied {
                output,
...
fn sandbox_outcome_from_tool_error(err: &ToolError) -> Option<&'static str> {
    match err {
        ToolError::Agent9527(Agent9527Err::Sandbox(SandboxErr::Denied { .. })) => Some("denied"),
        ToolError::Agent9527(Agent9527Err::Sandbox(SandboxErr::Timeout { .. })) => {
            Some("timed_out")
        }
        ToolError::Agent9527(Agent9527Err::Sandbox(SandboxErr::Signal(_))) => Some("signal"),
        ToolError::Rejected(_) | ToolError::Agent9527(_) => None,
    }
}
