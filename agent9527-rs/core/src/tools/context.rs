...
use agent9527_protocol::models::function_call_output_content_items_to_text;
...
use agent9527_utils_output_truncation::formatted_truncate_text;
...
pub enum ToolCallSource {
    ...
    CodeMode {
        ...
        /// debugging the JS/runtime bridge, but it is not the Agent9527 tool call id
