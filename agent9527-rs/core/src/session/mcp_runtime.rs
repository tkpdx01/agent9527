...
//! inputs and the mutable [`agent9527_mcp::McpRuntime`]. Background scheduling
//! belongs elsewhere.
...
pub(super) struct McpDesiredState {
    ...
    pub(super) auth: Option<Agent9527Auth>,
...
impl Session {
    ...
    pub(super) fn build_mcp_runtime_input(
        ...
        config
            .environment_cwds
            .entry(agent9527_config::DEFAULT_MCP_SERVER_ENVIRONMENT_ID.to_string())
        ...
        McpRuntimeInput {
            ...
            runtime_context,
            agent9527_apps_tools_cache: self.services.mcp_manager.agent9527_apps_tools_cache(),
