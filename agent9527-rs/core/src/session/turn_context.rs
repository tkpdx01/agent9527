...
use agent9527_core_plugins::TrustedPluginRoots;
use agent9527_core_skills::HostSkillsSnapshot;
use agent9527_file_system::FileSystemSandboxContext;
...
use agent9527_sandboxing::policy_transforms::effective_network_sandbox_policy;
...
pub struct TurnContext {
    ...
    pub(crate) extension_data: Arc<agent9527_extension_api::ExtensionData>,
...
impl TurnContext {
    ...
    pub(crate) fn apps_enabled(&self) -> bool {
        let uses_agent9527_backend = self
            .auth_manager
            .as_deref()
            .is_some_and(AuthManager::current_auth_uses_agent9527_backend);
        self.config
            .features
            .apps_enabled_for_auth(uses_agent9527_backend)
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        let unified_exec_shell_mode = UnifiedExecShellMode::for_session(
            agent9527_tools::unified_exec_feature_mode_for_features(per_turn_config.features.get()),
        ...
        let extension_data = Arc::new(agent9527_extension_api::ExtensionData::new(sub_id.clone()));
    ...
    pub(crate) async fn new_turn_with_sub_id(
    ...
    ) -> Agent9527Result<Arc<TurnContext>> {
        let notify_config_contributors = !self.services.extensions.config_contributors().is_empty();
        let update_result: Agent9527Result<_> = {
            ...
            match state.session_configuration.clone().apply(&updates) {
                ...
                Err(err) => Err(Agent9527Err::InvalidRequest(err.to_string())),
            }
        };
        ...
        let (
            ...
            Err(err) => {
                ...
                .await;
                return Err(Agent9527Err::InvalidRequest(message));
            }
        };
    ...
    async fn new_turn_context_from_configuration(
        ...
        let trusted_plugin_roots = TrustedPluginRoots::from_plugin_load_outcome(
            &plugin_outcome,
            per_turn_config.agent9527_home.as_path(),
        );
