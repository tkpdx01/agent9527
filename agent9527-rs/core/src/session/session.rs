...
impl Session {
    ...
    pub(crate) async fn new(
        ...
        let auth_and_mcp_fut = async move {
            ...
            let mcp_servers = agent9527_mcp::effective_mcp_servers(mcp_config, auth.as_ref());
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let auth_mode = auth.map(Agent9527Auth::auth_mode).map(TelemetryAuthMode::from);
            let account_id = auth.and_then(Agent9527Auth::get_account_id);
            let account_email = auth.and_then(Agent9527Auth::get_account_email);
            ...
            let agent9527_apps_auth_manager =
                agent9527_mcp::host_owned_agent9527_apps_enabled(&mcp_projection.config, auth)
            ...
            let mcp_connection_manager = McpConnectionManager::new(
                ...
                sess.services.mcp_manager.agent9527_apps_tools_cache(),
