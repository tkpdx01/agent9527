...
impl Session {
    ...
    async fn refresh_mcp_servers_inner(
        ...
        let tool_plugin_provenance = agent9527_mcp::tool_plugin_provenance(&mcp_config);
        ...
        let refreshed_manager = McpConnectionManager::new(
            ...
            mcp_config.agent9527_home.clone(),
            self.services.mcp_manager.agent9527_apps_tools_cache(),
