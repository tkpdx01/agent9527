...
pub async fn list_accessible_connectors_from_mcp_tools_with_mcp_manager(
    ...
    let mcp_connection_manager = McpConnectionManager::new(
        ...
        mcp_manager.agent9527_apps_tools_cache(),
    ...
    let agent9527_apps_ready = if refreshed_tools_succeeded {
        ...
        let immediate_ready = mcp_connection_manager
            .wait_for_server_ready(AGENT9527_APPS_MCP_SERVER_NAME, Duration::ZERO)
            .await;
        if immediate_ready {
            true
            ...
            let ready = mcp_connection_manager
                .wait_for_server_ready(AGENT9527_APPS_MCP_SERVER_NAME, timeout)
                .await;
