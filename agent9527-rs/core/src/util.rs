...
/// `agent9527_feedback::Agent9527Feedback::metadata_layer()` is installed, these fields are captured and
...
///
/// ```rust
/// agent9527_core::feedback_tags!(model = "gpt-5", cached = true);
/// agent9527_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
