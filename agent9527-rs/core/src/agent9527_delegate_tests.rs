...
use agent9527_protocol::protocol::GuardianAssessmentAction;
...
use agent9527_protocol::request_user_input::RequestUserInputEvent;
...
#[tokio::test]
async fn run_agent9527_thread_interactive_respects_pre_cancelled_spawn() {
    ...
    let result = timeout(
        ...
        run_agent9527_thread_interactive(
