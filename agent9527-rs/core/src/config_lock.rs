...
pub(crate) struct ConfigLockReplayOptions {
    pub allow_agent9527_version_mismatch: bool,
}
...
pub(crate) fn validate_config_lock_replay(
    ...
    if !options.allow_agent9527_version_mismatch
        && expected_lock.agent9527_version != actual_lock.agent9527_version
    {
        return Err(config_lock_error(format!(
            "config lock Agent9527 version mismatch: lock was generated by {}, current version is {}; set debug.config_lockfile.allow_agent9527_version_mismatch=true to ignore this",
            expected_lock.agent9527_version, actual_lock.agent9527_version
        )));
    }
...
fn config_lock_for_comparison(
    ...
    if options.allow_agent9527_version_mismatch {
        lockfile.agent9527_version.clear();
    }
    lockfile
}
