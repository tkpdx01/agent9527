...
command transformation live in the agent9527-sandboxing crate; this module keeps
...
#[cfg(target_os = "macos")]
use crate::spawn::AGENT9527_SANDBOX_ENV_VAR;
use crate::spawn::AGENT9527_SANDBOX_NETWORK_DISABLED_ENV_VAR;
...
pub use agent9527_protocol::models::SandboxPermissions;
...
pub(crate) struct ExecServerEnvConfig {
    pub(crate) policy: agent9527_exec_server::ExecEnvPolicy,
...
impl ExecRequest {
    ...
    pub(crate) fn from_sandbox_exec_request(
        ...
        if !network_sandbox_policy.is_enabled() {
            env.insert(
                AGENT9527_SANDBOX_NETWORK_DISABLED_ENV_VAR.to_string(),
                "1".to_string(),
            );
        }
        #[cfg(target_os = "macos")]
...
) -> agent9527_protocol::error::Result<ExecToolCallOutput> {
