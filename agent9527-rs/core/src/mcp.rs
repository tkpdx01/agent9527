...
use agent9527_connectors::PluginConnectorSource;
...
use agent9527_mcp::agent9527_apps_mcp_server_config;
use agent9527_mcp::configured_mcp_servers;
...
const LEGACY_AGENT9527_APPS_REGISTRATION_ID: &str = "legacy_agent9527_apps";
...
impl McpManager {
    pub fn new(plugins_manager: Arc<PluginsManager>) -> Self {
        Self::new_with_extensions(
            plugins_manager,
            agent9527_extension_api::empty_extension_registry(),
    ...
    pub fn agent9527_apps_tools_cache(&self) -> ConnectorRuntimeManager<ToolInfo> {
        self.agent9527_apps_tools_cache.clone()
    }
    ...
    async fn runtime_config_with_context(
        ...
        if mcp_config.apps_enabled {
            catalog.register(McpServerRegistration::from_compatibility(
                ...
                LEGACY_AGENT9527_APPS_REGISTRATION_ID,
