use agent9527_core_skills::AvailableSkills;
use agent9527_core_skills::SKILLS_HOW_TO_USE_WITH_ABSOLUTE_PATHS;
use agent9527_core_skills::SKILLS_HOW_TO_USE_WITH_ALIASES;
...
/// Model-context fragment describing the skills available to Agent9527.
