use crate::test_agent9527::TestAgent9527Builder;
use crate::test_agent9527::test_agent9527;
...
const AGENT9527_APPS_META_KEY: &str = "_agent9527_apps";
const AGENT9527_APPS_MCP_PATH_REGEX: &str = "^/api/agent9527/ps/mcp/?$";
const HOSTED_PLUGIN_RUNTIME_MCP_PATH_REGEX: &str = "^/api/agent9527/ps/mcp/?$";
const PROTOCOL_VERSION: &str = "2025-11-25";
const SERVER_NAME: &str = "agent9527-apps-test";
...
pub const DIRECT_CALENDAR_CREATE_EVENT_TOOL: &str = "mcp__agent9527_apps__calendar__create_event";
pub const DIRECT_CALENDAR_APP_ONLY_TOOL: &str = "mcp__agent9527_apps__calendar__app_only_action";
pub const DIRECT_CALENDAR_LIST_EVENTS_TOOL: &str = "mcp__agent9527_apps__calendar__list_events";
pub const DIRECT_CALENDAR_EXTRACT_TEXT_TOOL: &str = "mcp__agent9527_apps__calendar__extract_text";
pub const SEARCH_CALENDAR_NAMESPACE: &str = "mcp__agent9527_apps__calendar";
...
pub fn apps_enabled_builder(apps_base_url: impl Into<String>) -> TestAgent9527Builder {
...
pub fn search_capable_apps_builder(apps_base_url: impl Into<String>) -> TestAgent9527Builder {
    let apps_base_url = apps_base_url.into();
    test_agent9527()
        .with_auth(Agent9527Auth::create_dummy_chatgpt_auth_for_testing())
...
async fn mount_streamable_http_json_rpc_with_startup_control(
    ...
    Mock::given(method("POST"))
        ...
        .respond_with(Agent9527AppsJsonRpcResponder {
            connector_name,
            connector_description,
            searchable,
            include_app_only_tool,
...
struct Agent9527AppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
    include_app_only_tool: bool,
...
impl Respond for Agent9527AppsJsonRpcResponder {
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let agent9527_apps_meta = body.pointer("/params/_meta/_agent9527_apps").cloned();
                ...
                ResponseTemplate::new(200).set_body_json(json!({
                    ...
                    "result": {
                        ...
                        "structuredContent": {
                            "_agent9527_apps": agent9527_apps_meta,
                        },
                        "isError": false
                    }
                }))
