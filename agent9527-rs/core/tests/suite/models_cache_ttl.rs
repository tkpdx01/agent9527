...
use agent9527_models_manager::client_version_to_whole;
...
const REMOTE_MODEL: &str = "agent9527-test-ttl";
const VERSIONED_MODEL: &str = "agent9527-test-versioned";
const MISSING_VERSION_MODEL: &str = "agent9527-test-missing-version";
const DIFFERENT_VERSION_MODEL: &str = "agent9527-test-different-version";
...
async fn renews_cache_ttl_on_matching_models_etag() -> Result<()> {
    ...
    let agent9527 = Arc::clone(&test.agent9527);
    ...
    let cache_path = config.agent9527_home.join(CACHE_FILE);
    ...
    agent9527
        .submit(Op::UserInput {
            ...
            thread_settings: agent9527_protocol::protocol::ThreadSettingsOverrides {
                ...
                approval_policy: Some(agent9527_protocol::protocol::AskForApproval::Never),
    ...
    let _ = wait_for_event(&agent9527, |event| {
