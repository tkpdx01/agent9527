...
use agent9527_core::context::ApprovalPromptContext;
use agent9527_core::context::ContextualUserFragment;
use agent9527_core::context::PermissionsInstructions;
use agent9527_core::load_exec_policy;
use agent9527_models_manager::model_info::model_info_from_slug;
use agent9527_protocol::models::PermissionProfile;
use agent9527_protocol::openai_models::ApprovalMessages;
use agent9527_protocol::openai_models::ModelMessages;
use agent9527_protocol::openai_models::ModelsResponse;
use agent9527_protocol::openai_models::PermissionMessages;
...
) -> agent9527_protocol::openai_models::ModelInfo {
