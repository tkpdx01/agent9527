...
use super::Agent9527HomeUserInstructionsProvider;
use super::DEFAULT_AGENTS_MD_FILENAME;
use super::LOCAL_AGENTS_MD_FILENAME;

fn provider(home: &TempDir) -> Agent9527HomeUserInstructionsProvider {
    Agent9527HomeUserInstructionsProvider::new(
