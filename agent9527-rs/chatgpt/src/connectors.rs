...
use agent9527_connectors::ConnectorMetadataStore;
use agent9527_connectors::ConnectorToolSummary;
use agent9527_connectors::DirectoryListResponse;
use agent9527_connectors::merge::merge_connectors;
use agent9527_connectors::merge::merge_plugin_connectors;
use agent9527_core::config::Config;
pub use agent9527_core::connectors::list_accessible_connectors_from_mcp_tools;
pub use agent9527_core::connectors::list_accessible_connectors_from_mcp_tools_with_environment_manager;
pub use agent9527_core::connectors::list_accessible_connectors_from_mcp_tools_with_mcp_manager;
pub use agent9527_core::connectors::list_accessible_connectors_from_mcp_tools_with_options;
pub use agent9527_core::connectors::list_accessible_connectors_from_mcp_tools_with_options_and_status;
pub use agent9527_core::connectors::list_cached_accessible_connectors_from_mcp_tools;
pub use agent9527_core::connectors::with_app_enabled_state;
...
const DEFAULT_APPS_PRODUCT_SKU: &str = "agent9527";
...
async fn connector_auth(config: &Config) -> anyhow::Result<Agent9527Auth> {
    let auth_manager =
        AuthManager::shared_from_config(config, /*enable_agent9527_api_key_env*/ false).await;
    ...
    anyhow::ensure!(
        ...
        "ChatGPT connectors require Agent9527 backend auth"
    );
    Ok(auth)
}
...
pub async fn list_cached_all_connectors(
    ...
    let connectors = agent9527_connectors::cached_directory_connectors(&cache_context)?;
...
pub async fn list_all_connectors_with_options(
    ...
    let cache_context = connector_directory_cache_context(config, &auth);
    let connectors = agent9527_connectors::list_all_connectors_with_options(
        cache_context,
...
mod tests {
    use super::*;
    use agent9527_connectors::metadata::connector_install_url;
    use agent9527_plugin::AppConnectorId;
