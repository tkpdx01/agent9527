...
//! orchestration and rollout scanning live in `agent9527-core`.
...
pub const SQLITE_HOME_ENV: &str = "AGENT9527_SQLITE_HOME";
...
pub const DB_ERROR_METRIC: &str = "agent9527.db.error";
/// Metrics on backfill process. Tags: [status]
pub const DB_METRIC_BACKFILL: &str = "agent9527.db.backfill";
/// Metrics on backfill duration. Tags: [status]
pub const DB_METRIC_BACKFILL_DURATION_MS: &str = "agent9527.db.backfill.duration_ms";
/// SQLite initialization attempts. Tags: [status, phase, db, error]
pub const DB_INIT_METRIC: &str = "agent9527.sqlite.init.count";
/// SQLite initialization latency. Tags: [status, phase, db, error]
pub const DB_INIT_DURATION_METRIC: &str = "agent9527.sqlite.init.duration_ms";
/// Rollout fallback attempts. Tags: [caller, reason]
pub const DB_FALLBACK_METRIC: &str = "agent9527.sqlite.fallback.count";
