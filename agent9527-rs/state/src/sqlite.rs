...
/// Resolved configuration shared by all Agent9527 SQLite connections.
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl SqliteConfig {
    ...
    /// Open a writable Agent9527 SQLite database, creating it if necessary.
    ...
    /// Open an existing Agent9527 SQLite database without creating or modifying it.
