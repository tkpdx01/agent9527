...
use agent9527_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use agent9527_protocol::protocol::SkillInterface as CoreSkillInterface;
use agent9527_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use agent9527_protocol::protocol::SkillScope as CoreSkillScope;
use agent9527_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// Agent9527 app-server exposes `"AVAILABLE"` in its API; the alias keeps
