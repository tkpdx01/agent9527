...
use agent9527_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use agent9527_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
use agent9527_protocol::protocol::ThreadSource as CoreThreadSource;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. Agent9527-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Origin of the thread (CLI, VSCode, agent9527 exec, agent9527 app-server, etc.).
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. Agent9527-generated turn IDs are UUIDv7.
    pub id: String,
