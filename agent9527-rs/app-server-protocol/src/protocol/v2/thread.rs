...
pub use agent9527_protocol::capabilities::CapabilityRootLocation;
pub use agent9527_protocol::capabilities::SelectedCapabilityRoot;
...
use agent9527_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use agent9527_protocol::protocol::TokenUsage as CoreTokenUsage;
use agent9527_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "agent9527_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. Agent9527 Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR AGENT9527 CLOUD - DO NOT USE.
...
impl From<agent9527_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: agent9527_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> agent9527_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => agent9527_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => agent9527_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `agent9527_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
