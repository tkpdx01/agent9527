...
use agent9527_protocol::config_types::ApprovalsReviewer as CoreApprovalsReviewer;
use agent9527_protocol::config_types::SandboxMode as CoreSandboxMode;
...
use agent9527_protocol::protocol::NonSteerableTurnKind as CoreNonSteerableTurnKind;
...
/// This translation layer make sure that we expose agent9527 error code in camel case.
///
/// When an upstream HTTP status is available (for example, from the Responses API or a provider),
/// it is forwarded in `httpStatusCode` on the relevant `agent9527ErrorInfo` variant.
...
impl From<CoreAgent9527ErrorInfo> for Agent9527ErrorInfo {
    fn from(value: CoreAgent9527ErrorInfo) -> Self {
        match value {
            CoreAgent9527ErrorInfo::ContextWindowExceeded => {
                Agent9527ErrorInfo::ContextWindowExceeded
            }
            CoreAgent9527ErrorInfo::SessionBudgetExceeded => {
                Agent9527ErrorInfo::SessionBudgetExceeded
            }
            CoreAgent9527ErrorInfo::UsageLimitExceeded => Agent9527ErrorInfo::UsageLimitExceeded,
            CoreAgent9527ErrorInfo::ServerOverloaded => Agent9527ErrorInfo::ServerOverloaded,
            CoreAgent9527ErrorInfo::CyberPolicy => Agent9527ErrorInfo::CyberPolicy,
            CoreAgent9527ErrorInfo::HttpConnectionFailed { http_status_code } => {
                Agent9527ErrorInfo::HttpConnectionFailed { http_status_code }
            }
            CoreAgent9527ErrorInfo::ResponseStreamConnectionFailed { http_status_code } => {
                Agent9527ErrorInfo::ResponseStreamConnectionFailed { http_status_code }
            }
            CoreAgent9527ErrorInfo::InternalServerError => Agent9527ErrorInfo::InternalServerError,
            CoreAgent9527ErrorInfo::Unauthorized => Agent9527ErrorInfo::Unauthorized,
            CoreAgent9527ErrorInfo::BadRequest => Agent9527ErrorInfo::BadRequest,
            CoreAgent9527ErrorInfo::ThreadRollbackFailed => {
                Agent9527ErrorInfo::ThreadRollbackFailed
            }
            CoreAgent9527ErrorInfo::SandboxError => Agent9527ErrorInfo::SandboxError,
            CoreAgent9527ErrorInfo::ResponseStreamDisconnected { http_status_code } => {
                Agent9527ErrorInfo::ResponseStreamDisconnected { http_status_code }
            }
            CoreAgent9527ErrorInfo::ResponseTooManyFailedAttempts { http_status_code } => {
                Agent9527ErrorInfo::ResponseTooManyFailedAttempts { http_status_code }
            }
            CoreAgent9527ErrorInfo::ActiveTurnNotSteerable { turn_kind } => {
                Agent9527ErrorInfo::ActiveTurnNotSteerable {
                    turn_kind: turn_kind.into(),
                }
            }
            CoreAgent9527ErrorInfo::Other => Agent9527ErrorInfo::Other,
        }
    }
}
