...
use agent9527_protocol::openai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use agent9527_protocol::openai_models::ReasoningEffort;
use agent9527_protocol::openai_models::default_input_modalities;
use agent9527_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use agent9527_protocol::protocol::ModelVerification as CoreModelVerification;
