...
use agent9527_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use agent9527_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use agent9527_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use agent9527_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use agent9527_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use agent9527_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use agent9527_protocol::models::LegacyReadWriteRoots;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> agent9527_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<agent9527_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: agent9527_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            agent9527_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            agent9527_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            agent9527_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
