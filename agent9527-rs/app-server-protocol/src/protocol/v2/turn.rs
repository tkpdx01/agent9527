...
use agent9527_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use agent9527_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use agent9527_protocol::user_input::ByteRange as CoreByteRange;
use agent9527_protocol::user_input::TextElement as CoreTextElement;
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich Agent9527's ResponsesAPI turn metadata.
    ///
    /// Entries are flattened into the JSON string sent as
    /// `client_metadata["x-agent9527-turn-metadata"]` on ResponsesAPI HTTP and websocket requests.
    ///
