...
use agent9527_protocol::protocol::HookEventName as CoreHookEventName;
use agent9527_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use agent9527_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use agent9527_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use agent9527_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use agent9527_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use agent9527_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use agent9527_protocol::protocol::HookScope as CoreHookScope;
use agent9527_protocol::protocol::HookSource as CoreHookSource;
use agent9527_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
