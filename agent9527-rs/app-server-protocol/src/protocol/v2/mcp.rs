...
use agent9527_protocol::items::McpToolCallError as CoreMcpToolCallError;
use agent9527_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use agent9527_protocol::mcp::McpServerInfo;
use agent9527_protocol::mcp::Resource as McpResource;
pub use agent9527_protocol::mcp::ResourceContent as McpResourceContent;
use agent9527_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use agent9527_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from agent9527_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from agent9527_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> agent9527_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => agent9527_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => agent9527_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => agent9527_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Agent9527 turn when this elicitation was observed, if app-server could correlate one.
    ///
