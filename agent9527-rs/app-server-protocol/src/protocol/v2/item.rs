...
use agent9527_experimental_api_macros::ExperimentalApi;
use agent9527_extension_items::ExtensionItem;
pub use agent9527_extension_items::image_generation::ImageGenerationItem;
pub use agent9527_extension_items::sleep::SleepItem;
pub use agent9527_extension_items::web_search::WebSearchAction;
pub use agent9527_extension_items::web_search::WebSearchItem;
use agent9527_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use agent9527_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use agent9527_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
...
use agent9527_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use agent9527_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use agent9527_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use agent9527_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use agent9527_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: agent9527_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        agent9527_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        agent9527_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        agent9527_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        agent9527_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<agent9527_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: agent9527_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<agent9527_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: agent9527_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for agent9527_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
