...
use agent9527_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use agent9527_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use agent9527_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use agent9527_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use agent9527_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
...
pub enum Account {
    ...
    AmazonBedrock {
        #[serde(default)]
        uses_agent9527_managed_credentials: bool,
    },
}
    ...
    fn from(account: ProviderAccount) -> Self {
        match account {
            ...
            ProviderAccount::AmazonBedrock {
                uses_agent9527_managed_credentials,
            } => Self::AmazonBedrock {
                uses_agent9527_managed_credentials,
            },
        }
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that Agent9527-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Agent9527 attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Agent9527 attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Agent9527 was previously using.
    ///
...
pub struct GetAccountRateLimitsResponse {
    ...
    /// Multi-bucket view keyed by metered `limit_id` (for example, `agent9527`).
