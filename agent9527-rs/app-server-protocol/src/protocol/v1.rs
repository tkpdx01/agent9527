...
pub use agent9527_protocol::protocol::GitSha;
...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $AGENT9527_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [agent9527_protocol::protocol::PatchApplyBeginEvent]
    /// and [agent9527_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [agent9527_protocol::protocol::ExecCommandBeginEvent]
    /// and [agent9527_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
