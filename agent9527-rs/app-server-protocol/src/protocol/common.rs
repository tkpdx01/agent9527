...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by Agent9527.
    ApiKey,
    /// ChatGPT OAuth managed by Agent9527 (tokens persisted and refreshed by Agent9527).
    Chatgpt,
    ...
    Headers,
    /// Programmatic Agent9527 auth backed by a registered Agent Identity.
    #[serde(rename = "agentIdentity")]
    #[ts(rename = "agentIdentity")]
    #[strum(serialize = "agentIdentity")]
    AgentIdentity,
    /// Programmatic Agent9527 auth backed by a personal access token.
    #[serde(rename = "personalAccessToken")]
    #[ts(rename = "personalAccessToken")]
    #[strum(serialize = "personalAccessToken")]
    PersonalAccessToken,
    /// Amazon Bedrock bearer token managed by Agent9527.
...
impl AuthMode {
    ...
    /// Returns whether this mode is backed by Agent9527 services rather than a direct model API.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a Agent9527 sandbox.
...
/// Superset of [`agent9527_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Agent9527 Cloud.
...
mod tests {
    ...
    fn jsonrpc_request_conversion_preserves_serde_enum_decoding() {
        let requests = [
            JSONRPCRequest {
                ...
                trace: Some(agent9527_protocol::protocol::W3cTraceContext {
    ...
    fn serialize_mcp_server_elicitation_request() -> Result<()> {
        ...
        let params = v2::McpServerElicitationRequestParams {
            ...
            server_name: "agent9527_apps".to_string(),
        ...
        let response = ClientResponse::ThreadStart {
            ...
            response: v2::ThreadStartResponse {
                ...
                instruction_sources: vec![
                    agent9527_utils_path_uri::LegacyAppPathString::from_abs_path(&absolute_path(
                        "/tmp/AGENTS.md",
                    )),
                ],
    ...
    fn serialize_account_login_chatgpt_streamlined() -> Result<()> {
        let request = ClientRequest::LoginAccount {
            ...
            params: v2::LoginAccountParams::Chatgpt {
                app_brand: None,
                agent9527_streamlined_login: true,
                use_hosted_login_success_page: false,
            },
        };
        assert_eq!(
            json!({
                ...
                "params": {
                    "type": "chatgpt",
                    "appBrand": null,
                    "agent9527StreamlinedLogin": true
                }
            }),
            serde_json::to_value(&request)?,
        );
    ...
    fn account_serializes_fields_in_camel_case() -> Result<()> {
        ...
        let agent9527_managed_bedrock = v2::Account::AmazonBedrock {
            uses_agent9527_managed_credentials: true,
        };
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesAgent9527ManagedCredentials": true,
            }),
            serde_json::to_value(&agent9527_managed_bedrock)?,
        );

        let externally_managed_bedrock = v2::Account::AmazonBedrock {
            uses_agent9527_managed_credentials: false,
        };
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesAgent9527ManagedCredentials": false,
            }),
    ...
    fn serialize_thread_realtime_start() -> Result<()> {
        let request = ClientRequest::ThreadRealtimeStart {
            ...
            params: v2::ThreadRealtimeStartParams {
                ...
                agent9527_response_handoff_channel_prefixes: Some(
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "agent9527ResponsesAsItems": null,
                    "agent9527ResponseItemPrefix": null,
                    "agent9527ResponseHandoffMode": "bemTags",
    ...
    fn serialize_thread_realtime_start_prompt_default_and_null() -> Result<()> {
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "agent9527ResponsesAsItems": null,
                    "agent9527ResponseItemPrefix": null,
                    "agent9527ResponseHandoffMode": null,
                    "agent9527ResponseHandoffChannelPrefixes": null,
                    "model": null,
                    "outputModality": "audio",
        ...
        let default_prompt_value = json!({
            ...
            "params": {
                ...
                "agent9527ResponseHandoffPrefix": "",
                "outputModality": "audio",
                "realtimeSessionId": null,
                "transport": null,
                "voice": null
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: agent9527_protocol::config_types::CollaborationMode {
