...
use agent9527_extension_items::image_generation::ImageGenerationItem;
use agent9527_protocol::items::parse_hook_prompt_message;
use agent9527_protocol::models::MessagePhase;
use agent9527_protocol::protocol::AgentReasoningEvent;
use agent9527_protocol::protocol::AgentReasoningRawContentEvent;
...
use agent9527_protocol::protocol::ContextCompactedEvent;
use agent9527_protocol::protocol::DynamicToolCallResponseEvent;
use agent9527_protocol::protocol::ErrorEvent;
use agent9527_protocol::protocol::EventMsg;
use agent9527_protocol::protocol::ExecCommandBeginEvent;
use agent9527_protocol::protocol::ExecCommandEndEvent;
use agent9527_protocol::protocol::GuardianAssessmentEvent;
use agent9527_protocol::protocol::GuardianAssessmentStatus;
use agent9527_protocol::protocol::ImageGenerationBeginEvent;
use agent9527_protocol::protocol::ImageGenerationEndEvent;
use agent9527_protocol::protocol::ItemCompletedEvent;
use agent9527_protocol::protocol::ItemStartedEvent;
use agent9527_protocol::protocol::McpToolCallBeginEvent;
use agent9527_protocol::protocol::McpToolCallEndEvent;
use agent9527_protocol::protocol::PatchApplyBeginEvent;
use agent9527_protocol::protocol::PatchApplyEndEvent;
...
use agent9527_protocol::protocol::ViewImageToolCallEvent;
use agent9527_protocol::protocol::WebSearchBeginEvent;
use agent9527_protocol::protocol::WebSearchEndEvent;
#[cfg(test)]
use agent9527_protocol::review_format::REVIEW_FALLBACK_MESSAGE;
...
#[cfg(test)]
use agent9527_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
#[cfg(test)]
use agent9527_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `agent9527-rs/core/rollout/policy.rs`.
    ...
    fn handle_response_item(&mut self, item: &agent9527_protocol::models::ResponseItem) {
        let agent9527_protocol::models::ResponseItem::Message {
            role, content, id, ..
        } = item
        else {
            return;
    ...
    fn handle_materialized_item_lifecycle(
        &mut self,
        turn_id: &str,
        item: &agent9527_protocol::items::TurnItem,
    ) {
        let is_review_mode_item = matches!(
            item,
            agent9527_protocol::items::TurnItem::EnteredReviewMode(_)
                | agent9527_protocol::items::TurnItem::ExitedReviewMode(_)
        );
        let should_upsert = match item {
            agent9527_protocol::items::TurnItem::Plan(plan) => !plan.text.is_empty(),
            agent9527_protocol::items::TurnItem::HookPrompt(_)
            | agent9527_protocol::items::TurnItem::CommandExecution(_)
            | agent9527_protocol::items::TurnItem::DynamicToolCall(_)
            | agent9527_protocol::items::TurnItem::CollabAgentToolCall(_)
            | agent9527_protocol::items::TurnItem::SubAgentActivity(_)
            | agent9527_protocol::items::TurnItem::Extension(_)
            | agent9527_protocol::items::TurnItem::EnteredReviewMode(_)
            | agent9527_protocol::items::TurnItem::ExitedReviewMode(_) => true,
            agent9527_protocol::items::TurnItem::UserMessage(_)
            | agent9527_protocol::items::TurnItem::AgentMessage(_)
            | agent9527_protocol::items::TurnItem::Reasoning(_)
            | agent9527_protocol::items::TurnItem::WebSearch(_)
            | agent9527_protocol::items::TurnItem::ImageView(_)
            | agent9527_protocol::items::TurnItem::ImageGeneration(_)
            | agent9527_protocol::items::TurnItem::FileChange(_)
            | agent9527_protocol::items::TurnItem::McpToolCall(_)
            | agent9527_protocol::items::TurnItem::ContextCompaction(_) => false,
        };
    ...
    fn handle_dynamic_tool_call_request(
        &mut self,
        payload: &agent9527_protocol::dynamic_tools::DynamicToolCallRequest,
    ) {
    ...
    fn handle_collab_agent_spawn_begin(
        &mut self,
        payload: &agent9527_protocol::protocol::CollabAgentSpawnBeginEvent,
    ) {
    ...
    fn handle_collab_agent_spawn_end(
        &mut self,
        payload: &agent9527_protocol::protocol::CollabAgentSpawnEndEvent,
    ) {
    ...
    fn handle_collab_agent_interaction_begin(
        &mut self,
        payload: &agent9527_protocol::protocol::CollabAgentInteractionBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_agent_interaction_end(
        &mut self,
        payload: &agent9527_protocol::protocol::CollabAgentInteractionEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
    ...
    fn handle_sub_agent_activity(
        &mut self,
        payload: &agent9527_protocol::protocol::SubAgentActivityEvent,
    ) {
    ...
    fn handle_collab_waiting_begin(
        &mut self,
        payload: &agent9527_protocol::protocol::CollabWaitingBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_waiting_end(
        &mut self,
        payload: &agent9527_protocol::protocol::CollabWaitingEndEvent,
    ) {
    ...
    fn handle_collab_close_begin(
        &mut self,
        payload: &agent9527_protocol::protocol::CollabCloseBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_close_end(
        &mut self,
        payload: &agent9527_protocol::protocol::CollabCloseEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_collab_resume_begin(
        &mut self,
        payload: &agent9527_protocol::protocol::CollabResumeBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_resume_end(
        &mut self,
        payload: &agent9527_protocol::protocol::CollabResumeEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_entered_review_mode(
        &mut self,
        payload: &agent9527_protocol::protocol::EnteredReviewModeEvent,
    ) {
        let review = payload
            .user_facing_hint
            .clone()
    ...
    fn handle_exited_review_mode(
        &mut self,
        payload: &agent9527_protocol::protocol::ExitedReviewModeEvent,
    ) {
    ...
    fn handle_error(&mut self, payload: &ErrorEvent) {
        ...
        let changed_turn = if let Some(turn) = self.current_turn.as_mut() {
            ...
            turn.error = Some(V2TurnError {
                ...
                agent9527_error_info: payload.agent9527_error_info.clone().map(Into::into),
    ...
    fn handle_turn_complete(&mut self, payload: &TurnCompleteEvent) {
        let terminal_error = payload.error.as_ref().map(|error| V2TurnError {
            ...
            agent9527_error_info: error.agent9527_error_info.clone().map(Into::into),
            additional_details: None,
        });
...
fn convert_dynamic_tool_content_items(
    items: &[agent9527_protocol::dynamic_tools::DynamicToolCallOutputContentItem],
) -> Vec<DynamicToolCallOutputContentItem> {
    items
        .iter()
        .cloned()
        .map(|item| match item {
            agent9527_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputText {
                text,
            } => DynamicToolCallOutputContentItem::InputText { text },
            agent9527_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputImage {
                image_url,
            } => DynamicToolCallOutputContentItem::InputImage { image_url },
            agent9527_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputAudio {
                audio_url,
...
mod tests {
    ...
    use agent9527_extension_items::ExtensionItem as CoreExtensionItem;
    use agent9527_extension_items::sleep::SleepItem as CoreSleepItem;
    use agent9527_protocol::ThreadId;
    use agent9527_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
    use agent9527_protocol::items::CommandExecutionItem as CoreCommandExecutionItem;
    use agent9527_protocol::items::CommandExecutionStatus as CoreCommandExecutionStatus;
    use agent9527_protocol::items::EnteredReviewModeItem as CoreEnteredReviewModeItem;
    use agent9527_protocol::items::ExitedReviewModeItem as CoreExitedReviewModeItem;
    use agent9527_protocol::items::HookPromptFragment as CoreHookPromptFragment;
    use agent9527_protocol::items::TurnItem as CoreTurnItem;
    use agent9527_protocol::items::UserMessageItem as CoreUserMessageItem;
    use agent9527_protocol::items::build_hook_prompt_message;
    use agent9527_protocol::mcp::CallToolResult;
    use agent9527_protocol::models::ImageDetail;
    use agent9527_protocol::models::MessagePhase as CoreMessagePhase;
    use agent9527_protocol::models::WebSearchAction as CoreWebSearchAction;
    use agent9527_protocol::parse_command::ParsedCommand;
    ...
    use agent9527_protocol::protocol::CompactedItem;
    use agent9527_protocol::protocol::DynamicToolCallResponseEvent;
    use agent9527_protocol::protocol::EnteredReviewModeEvent;
    use agent9527_protocol::protocol::ExecCommandEndEvent;
    use agent9527_protocol::protocol::ExecCommandSource;
    use agent9527_protocol::protocol::ExitedReviewModeEvent;
    use agent9527_protocol::protocol::ItemStartedEvent;
    use agent9527_protocol::protocol::McpInvocation;
    use agent9527_protocol::protocol::McpToolCallEndEvent;
    use agent9527_protocol::protocol::PatchApplyBeginEvent;
    use agent9527_protocol::protocol::ReviewTarget;
    use agent9527_protocol::protocol::ThreadRolledBackEvent;
        ...
        let events = vec![
            ...
            EventMsg::ItemStarted(ItemStartedEvent {
                ...
                item: CoreTurnItem::UserMessage(CoreUserMessageItem {
                    ...
                    content: vec![agent9527_protocol::user_input::UserInput::Text {
                        text: "hello".into(),
                        text_elements: Vec::new(),
                    }],
                }),
    ...
    fn reconstructs_tool_items_from_persisted_completion_events() {
        let events = vec![
            ...
            EventMsg::WebSearchEnd(WebSearchEndEvent {
                ...
                query: "agent9527".into(),
                action: CoreWebSearchAction::Search {
                    query: Some("agent9527".into()),
                    queries: None,
                },
                results: Some(vec![serde_json::json!({
                    "type": "text_result",
                    "ref_id": "turn0search0",
                    "url": "https://example.com/agent9527",
                })]),
            }),
            EventMsg::ExecCommandEnd(ExecCommandEndEvent {
                call_id: "exec-1".into(),
    ...
    fn reconstructs_dynamic_tool_items_from_request_and_response_events() {
        let events = vec![
            ...
            EventMsg::DynamicToolCallRequest(
                agent9527_protocol::dynamic_tools::DynamicToolCallRequest {
                    call_id: "dyn-1".into(),
                    turn_id: "turn-1".into(),
                    started_at_ms: 0,
                    namespace: Some("agent9527_app".into()),
        ...
        let events = vec![
            ...
            EventMsg::PatchApplyEnd(PatchApplyEndEvent {
                ...
                changes: [(
                    ...
                    agent9527_protocol::protocol::FileChange::Add {
                        content: "hello\n".into(),
                    },
                )]
                .into_iter()
        ...
        let events = vec![
            ...
            EventMsg::TurnComplete(TurnCompleteEvent {
                ...
                error: Some(ErrorEvent {
                    ...
                    agent9527_error_info: Some(Agent9527ErrorInfo::ServerOverloaded),
                }),
                ...
                Turn {
                    ...
                    error: Some(TurnError {
                        message: "Selected model is at capacity. Please try a different model."
                            .into(),
                        agent9527_error_info: Some(
                            crate::protocol::v2::Agent9527ErrorInfo::ServerOverloaded,
                        ),
                        additional_details: None,
                    }),
                    started_at: Some(10),
    ...
    fn reconstructs_collab_resume_end_item() {
        let events = vec![
            ...
            EventMsg::CollabResumeEnd(agent9527_protocol::protocol::CollabResumeEndEvent {
    ...
    fn reconstructs_collab_spawn_end_item_with_model_metadata() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentSpawnEnd(agent9527_protocol::protocol::CollabAgentSpawnEndEvent {
                ...
                reasoning_effort: agent9527_protocol::openai_models::ReasoningEffort::Medium,
        ...
        assert_eq!(
            ...
            ThreadItem::CollabAgentToolCall {
                ...
                reasoning_effort: Some(agent9527_protocol::openai_models::ReasoningEffort::Medium),
                agents_states: [(
                    "00000000-0000-0000-0000-000000000002".into(),
                    CollabAgentState {
    ...
    fn reconstructs_interrupted_send_input_as_completed_collab_call() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentInteractionBegin(
                agent9527_protocol::protocol::CollabAgentInteractionBeginEvent {
                    call_id: "send-1".into(),
                    started_at_ms: 0,
            ...
            EventMsg::CollabAgentInteractionEnd(
                agent9527_protocol::protocol::CollabAgentInteractionEndEvent {
                    call_id: "send-1".into(),
                    completed_at_ms: 0,
                    sender_thread_id: sender,
                    receiver_thread_id: receiver,
    ...
    fn rollback_failed_error_does_not_mark_turn_failed() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                agent9527_error_info: Some(Agent9527ErrorInfo::ThreadRollbackFailed),
            }),
        ];
    ...
    fn error_then_turn_complete_preserves_failed_status() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                agent9527_error_info: Some(Agent9527ErrorInfo::ResponseStreamDisconnected {
        ...
        assert_eq!(
            ...
            Some(TurnError {
                message: "stream failure".into(),
                agent9527_error_info: Some(
                    crate::protocol::v2::Agent9527ErrorInfo::ResponseStreamDisconnected {
                        http_status_code: Some(502),
                    }
                ),
                additional_details: None,
    ...
    fn canonical_hook_prompt_completion_updates_turn_history() {
        let hook_prompt = CoreTurnItem::HookPrompt(agent9527_protocol::items::HookPromptItem {
    ...
    fn ignores_plain_user_response_items_in_rollout_replay() {
        let items = vec![
            ...
            RolloutItem::ResponseItem(agent9527_protocol::models::ResponseItem::Message {
                id: Some(agent9527_protocol::ResponseItemId::with_suffix("msg", "1")),
                role: "user".into(),
                content: vec![agent9527_protocol::models::ContentItem::InputText {
