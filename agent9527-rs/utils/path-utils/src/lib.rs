//! Path normalization, symlink resolution, and atomic writes shared across Agent9527 crates.
...
/// Compare paths after applying Agent9527's filesystem normalization.
///
