//! Helpers for truncating tool and exec output using [`TruncationPolicy`](agent9527_protocol::protocol::TruncationPolicy).

use agent9527_protocol::models::FunctionCallOutputContentItem;
pub use agent9527_utils_string::approx_bytes_for_tokens;
pub use agent9527_utils_string::approx_token_count;
pub use agent9527_utils_string::approx_tokens_from_byte_count;
use agent9527_utils_string::truncate_middle_chars;
use agent9527_utils_string::truncate_middle_with_token_budget;

pub use agent9527_protocol::protocol::TruncationPolicy;
