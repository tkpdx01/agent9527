# agent9527-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Agent9527 did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Agent9527 on it. Feel free to update the documentation as you
modify the code
...
```rust
use agent9527_utils_stream_parser::CitationStreamParser;
use agent9527_utils_stream_parser::StreamTextParser;
...
```rust
use agent9527_utils_stream_parser::CitationStreamParser;
use agent9527_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), agent9527_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use agent9527_utils_stream_parser::InlineHiddenTagParser;
use agent9527_utils_stream_parser::InlineTagSpec;
use agent9527_utils_stream_parser::StreamTextParser;
