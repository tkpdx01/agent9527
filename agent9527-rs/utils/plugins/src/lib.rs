//! Plugin path resolution, plaintext mention sigils, and MCP connector helpers shared across Agent9527
//! crates.
...
pub use agent9527_exec_server_protocol::DISCOVERABLE_PLUGIN_MANIFEST_PATHS;
