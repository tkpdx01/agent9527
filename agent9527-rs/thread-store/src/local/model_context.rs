...
use agent9527_rollout::ModelContextScan;
use agent9527_rollout::ModelContextScanProgress;
use agent9527_rollout::ReverseJsonlScanner;
use agent9527_rollout::ScanOutcome;
...
pub(super) async fn load_for_fork(
    ...
    let session_meta = agent9527_rollout::read_session_meta_line(source_path)
        .await
        .map_err(|err| ThreadStoreError::Internal {
            message: format!(
