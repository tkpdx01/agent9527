...
use agent9527_rollout::first_rollout_content_match_snippet;
use agent9527_rollout::parse_cursor;
use agent9527_rollout::search_rollout_matches;
...
struct ThreadSearchItem {
    item: agent9527_rollout::ThreadItem,
    snippet: String,
}
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = agent9527_rollout::plain_rollout_path(item.path.as_path());
...
) -> Option<agent9527_rollout::Cursor> {
