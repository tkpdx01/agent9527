...
pub use agent9527_utils_plugins::mention_syntax;
pub use agent9527_utils_plugins::plugin_namespace_for_skill_path;
...
pub struct PluginTelemetryMetadata {
    /// Local plugin identifier used by Agent9527 configuration and the plugin cache,
