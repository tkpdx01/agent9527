...
//! `~/.agent9527/config.toml` and normalizes user-entered key specs into canonical
//! forms consumed by runtime keymap resolution in `agent9527-rs/tui/src/keymap.rs`.
//!
//! Responsibilities:
//!
