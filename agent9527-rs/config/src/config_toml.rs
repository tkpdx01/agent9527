//! Schema-heavy configuration TOML types used by Agent9527.
...
use agent9527_protocol::config_types::WebSearchToolConfig;
...
use agent9527_utils_path::normalize_for_path_comparison;
...
/// Base config deserialized from ~/.agent9527/config.toml.
...
pub struct ConfigToml {
    ...
    /// sanctioned by Agent9527 will likely degrade model performance.
    ...
    /// file: Use a file in the Agent9527 home directory.
    ...
    /// Defaults to `$AGENT9527_SQLITE_HOME` when set. Otherwise uses `$AGENT9527_HOME`.
    pub sqlite_home: Option<AbsolutePathBuf>,

    /// Directory where Agent9527 writes log files. Setting this value explicitly
    /// also enables the TUI text log in this directory.
    /// Defaults to `$AGENT9527_HOME/log`.
    ...
    /// Optional product SKU forwarded on host-owned Agent9527 Apps MCP requests.
    ...
    /// directories for `.agent9527` folders. Defaults to [".git"] when unset.
    #[serde(default)]
...
pub struct DebugConfigLockToml {
    ...
    /// Allow replaying a lock generated by a different Agent9527 version.
    pub allow_agent9527_version_mismatch: Option<bool>,
...
pub use agent9527_protocol::protocol::RealtimeConversationVersion as RealtimeWsVersion;
pub use agent9527_protocol::protocol::RealtimeVoice;
