...
/// Provenance for one layer in the effective Agent9527 configuration.
...
pub enum ConfigLayerSource {
    ...
    /// Configuration loaded from a project's `.agent9527` directory.
    Project {
    ...
    match source {
        ...
        ConfigLayerSource::Project {
            ...
            format!(
                ...
                dot_agent9527_folder.as_path().display()
            )
        }
