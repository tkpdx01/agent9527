...
pub type LoadedPlugin = agent9527_plugin::LoadedPlugin<agent9527_config::McpServerConfig>;
pub type PluginLoadOutcome = agent9527_plugin::PluginLoadOutcome<agent9527_config::McpServerConfig>;
