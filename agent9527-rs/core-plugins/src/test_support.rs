...
pub(crate) async fn load_plugins_config(agent9527_home: &Path, cwd: &Path) -> PluginsConfigInput {
    let agent9527_home =
        AbsolutePathBuf::try_from(agent9527_home).expect("agent9527 home should be absolute");
