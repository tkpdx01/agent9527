use agent9527_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use agent9527_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use agent9527_app_server_protocol::CollabAgentTool;
use agent9527_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use agent9527_app_server_protocol::CommandAction;
use agent9527_app_server_protocol::CommandExecutionSource;
use agent9527_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use agent9527_app_server_protocol::ErrorNotification;
use agent9527_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
use agent9527_app_server_protocol::ItemCompletedNotification;
use agent9527_app_server_protocol::ItemStartedNotification;
use agent9527_app_server_protocol::McpToolCallError;
use agent9527_app_server_protocol::McpToolCallResult;
use agent9527_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use agent9527_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use agent9527_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use agent9527_app_server_protocol::WebSearchAction as ApiWebSearchAction;
use agent9527_app_server_protocol::WebSearchItem as ApiWebSearchItem;
...
use agent9527_exec::Agent9527Status;
use agent9527_exec::AgentMessageItem;
use agent9527_exec::CollabAgentState;
use agent9527_exec::CollabAgentStatus;
use agent9527_exec::CollabTool;
use agent9527_exec::CollabToolCallItem;
use agent9527_exec::CollabToolCallStatus;
use agent9527_exec::CollectedThreadEvents;
use agent9527_exec::CommandExecutionItem;
use agent9527_exec::CommandExecutionStatus;
use agent9527_exec::ErrorItem;
use agent9527_exec::EventProcessorWithJsonOutput;
use agent9527_exec::ExecThreadItem;
use agent9527_exec::FileChangeItem;
use agent9527_exec::FileUpdateChange as ExecFileUpdateChange;
use agent9527_exec::ItemCompletedEvent;
use agent9527_exec::ItemStartedEvent;
use agent9527_exec::ItemUpdatedEvent;
use agent9527_exec::McpToolCallItem;
use agent9527_exec::McpToolCallItemError;
use agent9527_exec::McpToolCallItemResult;
use agent9527_exec::McpToolCallStatus;
use agent9527_exec::PatchApplyStatus;
use agent9527_exec::PatchChangeKind;
use agent9527_exec::ReasoningItem;
use agent9527_exec::ThreadErrorEvent;
use agent9527_exec::ThreadEvent;
use agent9527_exec::ThreadItemDetails;
use agent9527_exec::ThreadStartedEvent;
use agent9527_exec::TodoItem;
use agent9527_exec::TodoListItem;
use agent9527_exec::TurnCompletedEvent;
use agent9527_exec::TurnFailedEvent;
use agent9527_exec::TurnStartedEvent;
use agent9527_exec::Usage;
use agent9527_exec::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_configured = SessionConfiguredEvent {
        ...
        thread_source: None,
        thread_name: None,
        model: "agent9527-mini-latest".to_string(),
        model_provider_id: "test-provider".to_string(),
        service_tier: None,
        approval_policy: AskForApproval::Never,
        approvals_reviewer: agent9527_protocol::config_types::ApprovalsReviewer::User,
...
fn turn_started_emits_turn_started_event() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: Agent9527Status::Running,
        }
    );
}
...
fn plan_update_emits_started_then_updated_then_completed() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: Agent9527Status::InitiateShutdown,
        }
    );
}
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            agent9527_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn failed_turn_clears_stale_final_message() {
    ...
    assert_eq!(collected.status, Agent9527Status::Running);
    ...
    assert_eq!(collected.status, Agent9527Status::InitiateShutdown);
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        agent9527_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: agent9527_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
