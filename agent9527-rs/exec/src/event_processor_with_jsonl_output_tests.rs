...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        agent9527_app_server_protocol::TurnCompletedNotification {
            ...
            turn: agent9527_app_server_protocol::Turn {
                ...
                error: Some(agent9527_app_server_protocol::TurnError {
    ...
    assert_eq!(status, Agent9527Status::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        agent9527_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "OpenAI Agent9527 CLI documentation"}]}),
                app_context: None,
