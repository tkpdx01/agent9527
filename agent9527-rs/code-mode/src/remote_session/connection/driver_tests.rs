...
use agent9527_code_mode_protocol::CellId;
use agent9527_code_mode_protocol::CodeModeNestedToolCall;
use agent9527_code_mode_protocol::CodeModeSessionDelegate;
use agent9527_code_mode_protocol::ExecuteRequest;
use agent9527_code_mode_protocol::NotificationFuture;
use agent9527_code_mode_protocol::ToolInvocationFuture;
use agent9527_code_mode_protocol::WaitRequest;
use agent9527_code_mode_protocol::host::ClientToHost;
use agent9527_code_mode_protocol::host::DelegateRequest;
use agent9527_code_mode_protocol::host::DelegateRequestId;
use agent9527_code_mode_protocol::host::EncodedFrame;
use agent9527_code_mode_protocol::host::HostResponse;
use agent9527_code_mode_protocol::host::HostToClient;
use agent9527_code_mode_protocol::host::MAX_PENDING_DELEGATE_CALLS;
use agent9527_code_mode_protocol::host::RequestId;
use agent9527_code_mode_protocol::host::SessionId;
use agent9527_code_mode_protocol::host::WireNestedToolCall;
use agent9527_code_mode_protocol::host::WireResult;
use agent9527_code_mode_protocol::host::WireRuntimeResponse;
use agent9527_code_mode_protocol::host::WireWaitOutcome;
...
struct DriverHarness {
    ...
    outgoing_rx: mpsc::Receiver<agent9527_code_mode_protocol::host::EncodedFrame>,
...
impl DriverHarness {
    ...
    async fn start_cell(
        ...
        request_id: i64,
        cell_id: &str,
    ) -> agent9527_code_mode_protocol::StartedCell {
        let (response_tx, response_rx) = oneshot::channel();
        self.command_tx
            ...
            .send(DriverEvent::HostMessage(HostToClient::DelegateRequest {
                ...
                request: DelegateRequest::InvokeTool {
                    invocation: WireNestedToolCall {
                        ...
                        tool_kind: agent9527_code_mode_protocol::CodeModeToolKind::Function.into(),
                        input: None,
                    },
                },
            }))
...
async fn terminate_closes_cell_without_waiting_for_delegate_cleanup() {
    ...
    assert_eq!(
        ...
        Ok(agent9527_code_mode_protocol::WaitOutcome::LiveCell(
            agent9527_code_mode_protocol::RuntimeResponse::Terminated {
                cell_id: CellId::new("1".to_string()),
                content_items: Vec::new(),
            }
        ))
...
async fn remote_wait_accepts_durations_longer_than_five_minutes() {
    ...
    assert_eq!(
        ...
        Ok(agent9527_code_mode_protocol::WaitOutcome::LiveCell(
            agent9527_code_mode_protocol::RuntimeResponse::Yielded {
                cell_id: CellId::new("1".to_string()),
                content_items: Vec::new(),
            }
        ))
