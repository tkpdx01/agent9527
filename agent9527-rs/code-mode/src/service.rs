...
use agent9527_code_mode_protocol::CodeModeSession;
use agent9527_code_mode_protocol::CodeModeSessionDelegate;
use agent9527_code_mode_protocol::CodeModeSessionProvider;
use agent9527_code_mode_protocol::CodeModeSessionProviderFuture;
use agent9527_code_mode_protocol::CodeModeSessionResultFuture;
use agent9527_code_mode_protocol::CodeModeToolKind;
use agent9527_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use agent9527_code_mode_protocol::ExecuteRequest;
use agent9527_code_mode_protocol::ExecuteToPendingOutcome;
use agent9527_code_mode_protocol::FunctionCallOutputContentItem;
use agent9527_code_mode_protocol::ImageDetail;
use agent9527_code_mode_protocol::NotificationFuture;
use agent9527_code_mode_protocol::RuntimeResponse;
use agent9527_code_mode_protocol::StartedCell;
use agent9527_code_mode_protocol::ToolInvocationFuture;
use agent9527_code_mode_protocol::WaitOutcome;
use agent9527_code_mode_protocol::WaitRequest;
use agent9527_code_mode_protocol::WaitToPendingOutcome;
use agent9527_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: agent9527_protocol::ToolName {
