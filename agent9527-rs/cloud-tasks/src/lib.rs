...
use agent9527_http_client::RouteAwareClientPool;
...
async fn init_backend(user_agent_suffix: &str) -> anyhow::Result<BackendContext> {
    ...
    let mut http =
        agent9527_cloud_tasks_client::HttpClient::new(base_url.clone(), http_client_factory)
            .with_user_agent(ua);
...
pub async fn run_main(
    ...
    let BackendContext {
        ...
        base_url,
        environment_http,
    } = init_backend("agent9527_cloud_tasks_tui").await?;
