...
impl From<&Agent9527Err> for Agent9527ErrKind {
    fn from(error: &Agent9527Err) -> Self {
        match error {
            Agent9527Err::TurnAborted => Agent9527ErrKind::TurnAborted,
            Agent9527Err::SessionBudgetExceeded => Agent9527ErrKind::SessionBudgetExceeded,
            Agent9527Err::Stream(..) => Agent9527ErrKind::Stream,
            Agent9527Err::ContextWindowExceeded => Agent9527ErrKind::ContextWindowExceeded,
            Agent9527Err::ThreadNotFound(_) => Agent9527ErrKind::ThreadNotFound,
            Agent9527Err::AgentLimitReached { .. } => Agent9527ErrKind::AgentLimitReached,
            Agent9527Err::SessionConfiguredNotFirstEvent => {
                Agent9527ErrKind::SessionConfiguredNotFirstEvent
            }
            Agent9527Err::Timeout => Agent9527ErrKind::Timeout,
            Agent9527Err::RequestTimeout => Agent9527ErrKind::RequestTimeout,
            Agent9527Err::Spawn => Agent9527ErrKind::Spawn,
            Agent9527Err::Interrupted => Agent9527ErrKind::Interrupted,
            Agent9527Err::UnexpectedStatus(_) => Agent9527ErrKind::UnexpectedStatus,
            Agent9527Err::InvalidRequest(_) => Agent9527ErrKind::InvalidRequest,
            Agent9527Err::InvalidImageRequest() => Agent9527ErrKind::InvalidImageRequest,
            Agent9527Err::UsageLimitReached(_) => Agent9527ErrKind::UsageLimitReached,
            Agent9527Err::ServerOverloaded => Agent9527ErrKind::ServerOverloaded,
            Agent9527Err::CyberPolicy { .. } => Agent9527ErrKind::CyberPolicy,
            Agent9527Err::ResponseStreamFailed(_) => Agent9527ErrKind::ResponseStreamFailed,
            Agent9527Err::ConnectionFailed(_) => Agent9527ErrKind::ConnectionFailed,
            Agent9527Err::QuotaExceeded => Agent9527ErrKind::QuotaExceeded,
            Agent9527Err::UsageNotIncluded => Agent9527ErrKind::UsageNotIncluded,
            Agent9527Err::InternalServerError => Agent9527ErrKind::InternalServerError,
            Agent9527Err::RetryLimit(_) => Agent9527ErrKind::RetryLimit,
            Agent9527Err::InternalAgentDied => Agent9527ErrKind::InternalAgentDied,
            Agent9527Err::Sandbox(_) => Agent9527ErrKind::Sandbox,
            Agent9527Err::LandlockSandboxExecutableNotProvided => {
                Agent9527ErrKind::LandlockSandboxExecutableNotProvided
            }
            Agent9527Err::UnsupportedOperation(_) => Agent9527ErrKind::UnsupportedOperation,
            Agent9527Err::RefreshTokenFailed(_) => Agent9527ErrKind::RefreshTokenFailed,
            Agent9527Err::Fatal(_) => Agent9527ErrKind::Fatal,
            Agent9527Err::Io(_) => Agent9527ErrKind::Io,
            Agent9527Err::Json(_) => Agent9527ErrKind::Json,
            #[cfg(target_os = "linux")]
            Agent9527Err::LandlockRuleset(_) => Agent9527ErrKind::LandlockRuleset,
            #[cfg(target_os = "linux")]
            Agent9527Err::LandlockPathFd(_) => Agent9527ErrKind::LandlockPathFd,
            Agent9527Err::TokioJoin(_) => Agent9527ErrKind::TokioJoin,
            Agent9527Err::EnvVar(_) => Agent9527ErrKind::EnvVar,
        }
    }
}
