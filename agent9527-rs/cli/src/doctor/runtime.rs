//! Captures how this Agent9527 process was launched.
//!
...
/// Builds the process provenance row for the current Agent9527 executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled Agent9527 package.");
    }
    check
}
...
fn build_commit() -> &'static str {
    option_env!("AGENT9527_BUILD_COMMIT")
