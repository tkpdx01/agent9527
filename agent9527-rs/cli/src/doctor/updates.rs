//! Diagnoses whether Agent9527 update paths target the running installation.
//!
...
const GITHUB_LATEST_RELEASE_URL: &str =
    "https://api.github.com/repos/openai/agent9527/releases/latest";
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/agent9527.json";
...
pub(super) fn updates_check(config: &Config) -> DoctorCheck {
    ...
    let version_file = config.agent9527_home.join(VERSION_FILE_NAME);
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g @tkpdx01/agent9527",
        InstallMethod::Bun => "bun install -g @tkpdx01/agent9527",
        InstallMethod::Pnpm => "pnpm add -g @tkpdx01/agent9527",
        InstallMethod::Brew => "brew upgrade --cask agent9527",
