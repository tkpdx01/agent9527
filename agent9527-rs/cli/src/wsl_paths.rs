...
pub use agent9527_utils_path::is_wsl;
...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\agent9527.zip").as_deref(),
            Some("/mnt/c/Temp/agent9527.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/agent9527.tgz").as_deref(),
            Some("/mnt/d/Work/agent9527.tgz")
        );
        assert!(win_path_to_wsl("/home/user/agent9527").is_none());
    }
