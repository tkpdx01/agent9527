...
//! `EscalateRequest` over the inherited `AGENT9527_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `AGENT9527_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use agent9527_protocol::approvals::EscalationPermissions;
pub use agent9527_protocol::approvals::ResolvedPermissionProfile;
