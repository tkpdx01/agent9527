...
use crate::AGENT9527_API_KEY_ENV_VAR;
...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            agent9527_api_key_env_present: self.agent9527_api_key_env_present,
            agent9527_api_key_env_enabled: self.agent9527_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    agent9527_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        agent9527_api_key_env_present: env_var_present(AGENT9527_API_KEY_ENV_VAR),
        agent9527_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*agent9527_api_key_env_enabled*/ false);
