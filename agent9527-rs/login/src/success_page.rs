...
pub const AGENT9527_OPEN_APP_URL: &str = "https://chatgpt.com/agent9527/open-app";
...
pub(crate) fn compose_success_url(
    ...
    if agent9527_streamlined_login {
        params.push(("agent9527_streamlined_login", "true".to_string()));
    }
    let query = params
        .into_iter()
