...
use agent9527_client::ReqwestTransport;
...
async fn models_client_hits_models_endpoint() {
    ...
    let base_url = format!("{}/api/agent9527", server.uri());
    ...
    assert_eq!(received[0].url.path(), "/api/agent9527/models");
}
