...
impl<T: HttpTransport> ModelsClient<T> {
    ...
    fn append_client_version_query(req: &mut agent9527_client::Request, client_version: &str) {
...
mod tests {
    ...
    async fn appends_client_version_query() {
        ...
        let provider = provider("https://example.com/api/agent9527");
        ...
        assert_eq!(
            url,
            "https://example.com/api/agent9527/models?client_version=0.99.0"
        );
    }
