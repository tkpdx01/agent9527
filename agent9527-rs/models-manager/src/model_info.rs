...
use agent9527_protocol::openai_models::TruncationMode;
...
const DEFAULT_PERSONALITY_HEADER: &str = "You are Agent9527, a coding agent using the configured model. You and the user share the same workspace and collaborate to achieve the user's goals.";
...
fn local_personality_messages_for_slug(slug: &str) -> Option<ModelMessages> {
    match slug {
        "gpt-5.2-agent9527" | "exp-agent9527-personality" => Some(ModelMessages {
