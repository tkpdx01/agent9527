use agent9527_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use agent9527_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use agent9527_protocol::config_types::CollaborationModeMask;
use agent9527_protocol::config_types::ModeKind;
use agent9527_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
