...
use agent9527_rmcp_client::StoredOAuthTokens;
use agent9527_rmcp_client::stored_oauth_credentials;
...
pub(crate) struct McpServerConnectionIdentity {
    ...
    runtime_auth: Option<Agent9527Auth>,
    runtime_auth_token: Option<String>,
    agent9527_apps_cache_identity: Option<(PathBuf, ConnectorRuntimeContextKey)>,
...
impl McpServerConnectionIdentity {
    ...
    pub(crate) fn has_same_connection_config(&self, other: &Self) -> bool {
        let same_runtime_auth = match (&self.runtime_auth, &other.runtime_auth) {
            (
                Some(Agent9527Auth::AgentIdentity(left)),
                Some(Agent9527Auth::AgentIdentity(right)),
        ...
        self.transport == other.transport
            ...
            && self.agent9527_apps_cache_identity == other.agent9527_apps_cache_identity
