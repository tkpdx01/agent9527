...
/// Backward-compatible name for the shared Agent9527 Apps tools runtime.
pub type Agent9527AppsToolsCache = agent9527_connectors::ConnectorRuntimeManager<ToolInfo>;
/// Backward-compatible name for the Agent9527 Apps runtime context key.
pub type Agent9527AppsToolsCacheKey = agent9527_connectors::ConnectorRuntimeContextKey;
...
pub use mcp::AGENT9527_APPS_MCP_SERVER_NAME;
pub use mcp::McpConfig;
pub use mcp::ToolPluginProvenance;
pub use server::EffectiveMcpServer;

/// Backward-compatible name for the Agent9527 Apps runtime context key builder.
pub use agent9527_connectors::connector_runtime_context_key as agent9527_apps_tools_cache_key;
pub use auth_elicitation::Agent9527AppsAuthElicitation;
pub use auth_elicitation::Agent9527AppsAuthElicitationPlan;
pub use auth_elicitation::Agent9527AppsConnectorAuthFailure;
pub use auth_elicitation::MCP_TOOL_AGENT9527_APPS_META_KEY;
...
pub use mcp::agent9527_apps_mcp_server_config;
pub use mcp::configured_mcp_servers;
pub use mcp::effective_mcp_servers;
pub use mcp::effective_mcp_servers_from_configured;
pub use mcp::host_owned_agent9527_apps_enabled;
...
pub use agent9527_apps::declared_openai_file_input_param_names;
pub use mcp::McpPermissionPromptAutoApproveContext;
pub use mcp::mcp_permission_prompt_is_auto_approved;
pub use mcp::qualified_mcp_tool_name_prefix;

pub(crate) mod agent9527_apps;
