...
impl Agent9527AppsStartupReconnect {
    ...
    fn with_startup_status_context(
        ...
        self.startup_status_context = tx_event.map(|tx_event| Agent9527AppsStartupStatusContext {
            submit_id,
            server_name,
            tx_event,
        });
...
/// server when absent.
pub(crate) fn prepare_agent9527_apps_tools_for_model(
...
async fn start_server_task(
    ...
    let shared_tools = match (agent9527_apps_tools_cache_context.as_ref(), fetch_ticket) {
