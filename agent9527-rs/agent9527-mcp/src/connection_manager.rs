...
use startup::should_share_agent9527_apps_tools_cache;
...
use crate::rmcp_client::prepare_agent9527_apps_tools_for_model;
...
impl McpServerView {
    async fn listed_tools(
        ...
        Some(if self.connection.client.is_agent9527_apps_mcp_server {
            prepare_agent9527_apps_tools_for_model(tools, tool_plugin_provenance)
        } else {
...
pub(crate) struct McpConnectionSet {
    ...
    agent9527_apps_tools_override: RwLock<Option<Vec<ToolInfo>>>,
    agent9527_apps_refresh_lock: Mutex<()>,
...
impl McpConnectionSet {
    ...
    pub async fn new(
        ...
        let McpRuntimeInput {
            ...
            tool_catalog_cache,
            agent9527_apps_tools_cache_key,
            ...
            .filter(|(_, server)| server.enabled())
        {
            ...
            let connection_identity = McpServerConnectionIdentity::new(
                ...
                auth,
                shares_agent9527_apps_tools_cache.then(|| {
                    (
                        agent9527_home.clone(),
                        agent9527_apps_tools_cache_key.clone(),
                    )
