...
const ENVIRONMENT_CLIENT_NAME: &str = "agent9527-environment";
...
impl ExecServerClient {
    ...
    #[tracing::instrument(name = "agent9527.exec_server.remote.noise.connect", skip_all)]
    ...
    #[tracing::instrument(
        name = "agent9527.exec_server.remote.harness.connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "agent9527.exec_server.remote.harness.connect",
        )
    )]
    ...
    #[tracing::instrument(
        name = "agent9527.exec_server.remote.noise.websocket_connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "agent9527.exec_server.remote.noise.websocket_connect",
