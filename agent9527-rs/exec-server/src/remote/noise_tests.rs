        ...
        tracing_subscriber::fmt::layer()
            ...
            .with_filter(
                tracing_subscriber::filter::Targets::new()
                    .with_target("agent9527_http_client", tracing::Level::TRACE)
                    .with_target("agent9527_exec_server", tracing::Level::TRACE),
            ),
    );
    let _guard = tracing::subscriber::set_default(subscriber);
    tracing::debug!(target: "agent9527_exec_server", "registry log capture sentinel");
