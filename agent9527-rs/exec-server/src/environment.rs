...
impl EnvironmentManager {
    ...
    pub async fn prepare_from_agent9527_home(
    ...
    /// Builds a manager from `AGENT9527_HOME` with an explicit outbound HTTP policy.
    pub async fn from_agent9527_home(
        agent9527_home: impl AsRef<std::path::Path>,
        local_runtime_paths: Option<ExecServerRuntimePaths>,
        http_client_factory: HttpClientFactory,
    ) -> Result<Self, ExecServerError> {
        Self::prepare_from_agent9527_home(agent9527_home)
            .await?
