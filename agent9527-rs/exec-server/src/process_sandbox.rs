...
use agent9527_sandboxing::WindowsSandboxProxySettingsMode;
use agent9527_sandboxing::WindowsSandboxSpawnRequest;
...
#[cfg(unix)]
use crate::AGENT9527_ARG0_EXEC_HELPER_ARG1;
...
pub(crate) async fn prepare_exec_request(
    ...
    let sandbox_helper_paths = params
        .arg0
        .iter()
        .map(|_| runtime_paths.agent9527_self_exe.clone())
        .collect::<Vec<_>>();
    ...
    let sandbox_helper_paths = {
        ...
        if !sandbox_helper_paths.contains(&runtime_paths.agent9527_self_exe) {
            sandbox_helper_paths.push(runtime_paths.agent9527_self_exe.clone());
        }
        sandbox_helper_paths.extend(runtime_paths.agent9527_linux_sandbox_exe.iter().cloned());
    ...
    let (program, args) = params.arg0.as_ref().map_or_else(
        ...
        |arg0| {
            ...
            helper_args.push(AGENT9527_ARG0_EXEC_HELPER_ARG1.to_string());
    ...
    let transform_request = SandboxDirectSpawnTransformRequest {
        ...
        transform: SandboxTransformRequest {
            ...
            network: None,
            sandbox_policy_cwd,
            agent9527_linux_sandbox_exe: runtime_paths.agent9527_linux_sandbox_exe.as_deref(),
