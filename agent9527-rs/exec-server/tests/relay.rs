...
#[path = "../src/proto/agent9527.exec_server.relay.v1.rs"]
mod relay_proto;
...
use agent9527_exec_server::EnvironmentConnectionState;
use agent9527_exec_server::EnvironmentManager;
use agent9527_exec_server::EnvironmentReadyInfo;
use agent9527_exec_server::ExecParams;
use agent9527_exec_server::ExecResponse;
use agent9527_exec_server::ExecServerClient;
use agent9527_exec_server::ExecServerError;
use agent9527_exec_server::ExecServerRuntimePaths;
use agent9527_exec_server::FsReadFileParams;
use agent9527_exec_server::NoiseChannelIdentity;
use agent9527_exec_server::NoiseChannelPublicKey;
use agent9527_exec_server::NoiseRendezvousConnectArgs;
use agent9527_exec_server::NoiseRendezvousConnectBundle;
use agent9527_exec_server::NoiseRendezvousConnectProvider;
use agent9527_exec_server::ProcessId;
use agent9527_exec_server::RemoteEnvironmentConfig;
use agent9527_http_client::HttpClientFactory;
use agent9527_http_client::OutboundProxyPolicy;
use agent9527_http_client::cache_system_proxy_route_for_test;
...
fn static_registry_auth_provider() -> agent9527_api::SharedAuthProvider {
...
async fn deferred_noise_environment_connects_and_reconnects_with_fresh_bundle() -> Result<()> {
    ...
    let (agent9527_exe, agent9527_linux_sandbox_exe) = common::current_test_binary_helper_paths()?;
    let runtime_paths = ExecServerRuntimePaths::new(agent9527_exe, agent9527_linux_sandbox_exe)?;
    ...
    let remote_environment = tokio::spawn(agent9527_exec_server::run_remote_environment(
        config,
        runtime_paths,
    ));
...
async fn remote_environment_routes_encrypted_exec_server_rpc() -> Result<()> {
    ...
    let client_args = NoiseRendezvousConnectArgs {
        ...
        http_client_factory: agent9527_http_client::HttpClientFactory::new(
