...
use agent9527_exec_server::FsCloseParams;
use agent9527_exec_server::FsOpenParams;
use agent9527_exec_server::FsReadBlockParams;
use agent9527_exec_server::FsReadBlockResponse;
...
async fn file_reads_reject_named_pipes() -> Result<()> {
    ...
    let read_path = format!(r"\\.\pipe\agent9527-fs-read-{}", Uuid::new_v4());
    ...
    let stream_path = format!(r"\\.\pipe\agent9527-fs-stream-{}", Uuid::new_v4());
