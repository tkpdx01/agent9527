...
pub use agent9527_file_system::WalkOptions;
pub use agent9527_file_system::WalkOutcome;
...
use agent9527_shell_command::shell_detect::DetectedShell;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        Self {
            shell: agent9527_shell_command::shell_detect::default_user_shell().into(),
...
pub struct ExecParams {
    ...
    #[serde(default)]
    pub pipe_stdin: bool,
    /// Optional process-visible argv0 override. Values such as `agent9527-linux-sandbox` are command
...
mod tests {
    ...
    use agent9527_network_proxy::RemoteNetworkProxyLaunchConfig;
    use agent9527_protocol::config_types::WindowsSandboxProxySettingsMode;
