...
use agent9527_code_mode::CodeModeSessionDelegate;
...
use agent9527_code_mode::FunctionCallOutputContentItem;
use agent9527_code_mode::NotificationFuture;
use agent9527_code_mode::ProcessOwnedCodeModeSessionProvider;
use agent9527_code_mode::RuntimeResponse;
use agent9527_code_mode::ToolDefinition;
use agent9527_code_mode::ToolInvocationFuture;
use agent9527_code_mode::WaitOutcome;
use agent9527_code_mode::WaitRequest;
use agent9527_code_mode::host::MAX_FRAME_BYTES;
...
async fn remote_session_persists_values_forwards_delegates_and_controls_cells() {
    let provider = ProcessOwnedCodeModeSessionProvider::with_host_program(
        agent9527_utils_cargo_bin::cargo_bin("agent9527-code-mode-host").expect("host binary"),
    );
