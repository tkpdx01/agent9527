...
use agent9527_code_mode_protocol::host::Capability;
use agent9527_code_mode_protocol::host::CapabilitySet;
use agent9527_code_mode_protocol::host::ClientHello;
use agent9527_code_mode_protocol::host::ClientToHost;
use agent9527_code_mode_protocol::host::DelegateRequest;
use agent9527_code_mode_protocol::host::DelegateResponse;
use agent9527_code_mode_protocol::host::EncodedFrame;
use agent9527_code_mode_protocol::host::HostHello;
use agent9527_code_mode_protocol::host::HostRequest;
use agent9527_code_mode_protocol::host::HostResponse;
use agent9527_code_mode_protocol::host::HostToClient;
use agent9527_code_mode_protocol::host::MAX_FRAME_BYTES;
use agent9527_code_mode_protocol::host::ProtocolVersion;
use agent9527_code_mode_protocol::host::RequestId;
use agent9527_code_mode_protocol::host::SessionId;
use agent9527_code_mode_protocol::host::SupportedProtocolVersions;
use agent9527_code_mode_protocol::host::WireContentItem;
use agent9527_code_mode_protocol::host::WireExecuteRequest;
use agent9527_code_mode_protocol::host::WireResult;
use agent9527_code_mode_protocol::host::WireRuntimeResponse;
use agent9527_code_mode_protocol::host::WireToolDefinition;
use agent9527_code_mode_protocol::host::WireToolKind;
use agent9527_code_mode_protocol::host::WireToolName;
use anyhow::Context;
use anyhow::Result;
use futures::SinkExt;
...
impl HostHarness {
    async fn start() -> Result<Self> {
        let host_program = agent9527_utils_cargo_bin::cargo_bin("agent9527-code-mode-host")?;
