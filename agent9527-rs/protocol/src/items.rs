...
pub struct WebSearchItem {
    ...
    ///
    /// These stay as opaque JSON at the Agent9527 transport boundary so new result
    /// fields and result types can pass through without changing model-visible
    /// context or requiring a Agent9527 release.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional)]
...
mod tests {
    ...
    fn plugin_relative_paths_use_safe_wire_shape() {
        ...
        for path in [
            "",
            "/home/user/.agent9527/plugins/cache/sample/scripts/run.py",
            "C:/Users/user/.agent9527/plugins/cache/sample/scripts/run.py",
            "scripts/C:/run.py",
