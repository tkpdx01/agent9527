//! Shared model metadata types exchanged between Agent9527 services and clients.
//!
...
/// Metadata describing a Agent9527-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Agent9527 backend `/models` endpoint.
