...
//! agent9527 home directory creation and git safe.directory injection so sandboxed
...
/// Ensure the sandbox agent9527 home directory exists.
pub fn ensure_agent9527_home_exists(p: &Path) -> Result<()> {
...
mod tests {
    ...
    fn injects_worktree_root_for_gitfile() {
        ...
        fs::write(
            repo.join(".git"),
            "gitdir: C:/Users/example/repo/.git/worktrees/agent95273\n",
        )
