...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        agent9527_home: PathBuf::from(r"C:\Users\agent9527"),
        cwd: PathBuf::from(r"C:\workspace"),
        env_map: env_map.clone(),
        logs_base_dir: Some(PathBuf::from(r"C:\Users\agent9527\.sandbox")),
        spawn_request: SpawnRequest {
            ...
            agent9527_home: PathBuf::from(r"C:\Users\agent9527\.sandbox"),
            real_agent9527_home: PathBuf::from(r"C:\Users\agent9527"),
        ...
        deny_write_paths_override: vec![PathBuf::from(r"C:\workspace\.agent9527")],
        proxy_enforced: true,
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        agent9527_home: request.agent9527_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |agent9527_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
