...
const SESSION_NAME: &str = "Agent9527 Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Agent9527 Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Agent9527 Windows sandbox filters";
const SUBLAYER_NAME: &str = "Agent9527 Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Agent9527 Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Agent9527-owned identities; do not regenerate them unless we
...
/// Installs the persistent Agent9527 WFP filters for `account`.
///
...
/// Ensures the persistent Agent9527 WFP provider exists.
...
/// Ensures the persistent Agent9527 sublayer exists under the Agent9527 provider.
