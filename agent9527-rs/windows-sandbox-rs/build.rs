...
const SETUP_BIN: &str = "agent9527-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "agent9527-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so Agent9527 binaries that link the
