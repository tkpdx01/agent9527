pub(crate) const OTEL_TARGET_PREFIX: &str = "agent9527_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "agent9527_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "agent9527_otel.trace_safe";
