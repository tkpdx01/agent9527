...
Set a stable path to the skill CLI (default `AGENT9527_HOME` is `~/.agent9527`):

```
export AGENT9527_HOME="${AGENT9527_HOME:-$HOME/.agent9527}"
export IMAGE_GEN="$AGENT9527_HOME/skills/.system/imagegen/scripts/image_gen.py"
```
...
- Network/sandbox notes for fallback CLI mode: `references/agent9527-network.md`
- Built-in-first transparent image workflow: `SKILL.md` and `$AGENT9527_HOME/skills/.system/imagegen/scripts/remove_chroma_key.py`
