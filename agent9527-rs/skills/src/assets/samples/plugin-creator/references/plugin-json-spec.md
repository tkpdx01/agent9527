...
- This repo’s scaffold writes `.agent9527-plugin/plugin.json`; treat that as the manifest location this skill generates.
...
- `plugins` (`array`): Ordered plugin entries. This order determines how Agent9527 renders plugins.
