...
pub(crate) fn completed_summary(
    ...
    entries: Vec<agent9527_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
...
pub(crate) fn hook_source_label(source: agent9527_protocol::protocol::HookSource) -> &'static str {
    match source {
        agent9527_protocol::protocol::HookSource::System => "system",
        agent9527_protocol::protocol::HookSource::User => "user",
        agent9527_protocol::protocol::HookSource::Project => "project",
        agent9527_protocol::protocol::HookSource::Mdm => "mdm",
        agent9527_protocol::protocol::HookSource::SessionFlags => "session_flags",
        agent9527_protocol::protocol::HookSource::Plugin => "plugin",
        agent9527_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        agent9527_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
        agent9527_protocol::protocol::HookSource::LegacyManagedConfigFile => {
            "legacy_managed_config_file"
        }
        agent9527_protocol::protocol::HookSource::LegacyManagedConfigMdm => {
            "legacy_managed_config_mdm"
        }
        agent9527_protocol::protocol::HookSource::Unknown => "unknown",
    }
}
