...
pub(crate) struct ConfiguredHandler {
    pub event_name: agent9527_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            agent9527_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            agent9527_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            agent9527_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            agent9527_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            agent9527_protocol::protocol::HookEventName::PostCompact => "post-compact",
            agent9527_protocol::protocol::HookEventName::SessionStart => "session-start",
            agent9527_protocol::protocol::HookEventName::SessionEnd => "session-end",
            agent9527_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            agent9527_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            agent9527_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            agent9527_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<agent9527_protocol::items::HookPromptFragment>,
    ) -> Vec<agent9527_protocol::items::HookPromptFragment> {
        self.output_spiller
