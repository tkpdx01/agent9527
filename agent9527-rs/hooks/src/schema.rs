...
pub(crate) struct PreToolUseCommandInput {
    ...
    /// Agent9527 extension: expose the active turn id to internal turn-scoped hooks.
    pub turn_id: String,
...
mod tests {
    ...
    #[test]
    fn turn_scoped_hook_inputs_include_agent9527_turn_id_extension() {
        // Agent9527 intentionally diverges from Claude's public hook docs here so
