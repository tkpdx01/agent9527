...
const ITEM_BYTES_METRIC: &str = "agent9527.rollout.persistence.item_bytes";
const APPEND_METRIC: &str = "agent9527.rollout.persistence.append";
const TURN_BYTES_METRIC: &str = "agent9527.rollout.persistence.turn_bytes";
const MEASUREMENT_ERROR_METRIC: &str = "agent9527.rollout.persistence.measurement_error";
...
impl RolloutPersistenceTelemetry {
    pub fn new(thread_id: ThreadId) -> Self {
        let metrics = agent9527_otel::global();
