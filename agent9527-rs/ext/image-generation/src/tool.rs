...
use agent9527_api::ImageBackground;
use agent9527_api::ImageEditRequest;
use agent9527_api::ImageGenerationRequest;
use agent9527_api::ImageQuality;
use agent9527_api::ImageUrl;
use agent9527_core::context::extension_image_generation_output_hint;
use agent9527_core::image_generation_artifact_path;
...
use agent9527_extension_api::ExtensionTurnItem;
use agent9527_extension_api::FunctionCallError;
use agent9527_extension_api::ToolCall;
use agent9527_extension_api::ToolEnvironment;
...
use agent9527_extension_api::parse_tool_input_schema;
...
use agent9527_utils_image::PromptImageMode;
use agent9527_utils_image::load_for_prompt_bytes;
...
pub(crate) struct ImageGenerationTool {
    backend: Agent9527ImagesBackend,
...
impl ToolExecutor<ToolCall> for ImageGenerationTool {
    ...
    fn handle(&self, call: ToolCall) -> agent9527_extension_api::ToolExecutorFuture<'_> {
