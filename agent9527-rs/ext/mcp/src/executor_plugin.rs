use agent9527_connectors_extension::ExecutorPluginConnectorProvider;
use agent9527_core::config::Config;
use agent9527_core_plugins::ExecutorPluginProvider;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, agent9527_config::McpServerConfig)>,
