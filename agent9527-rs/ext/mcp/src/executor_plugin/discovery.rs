...
use agent9527_core_plugins::manifest::parse_plugin_manifest_uri;
use agent9527_exec_server::CapabilityRootDiscovery;
use agent9527_mcp::parse_executor_plugin_mcp_config;
...
fn parse_mcp_servers(
    selected_root: &SelectedCapabilityRoot,
    plugin_root: &agent9527_utils_path_uri::PathUri,
    contents: &str,
    environment_id: &str,
) -> Vec<(String, agent9527_config::McpServerConfig)> {
