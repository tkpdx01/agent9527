    ...
    B: MemoriesBackend,
{
    ...
    fn spec(&self) -> ToolSpec {
        memory_function_tool::<SearchArgs, SearchMemoriesResponse>(
            SEARCH_TOOL_NAME,
            "Search Agent9527 memory files for substring matches, optionally normalizing separators or requiring all query substrings on the same line or within a line window.",
        )
    }
    ...
    B: MemoriesBackend,
{
    async fn handle_call(
        ...
        Box<dyn agent9527_extension_api::ToolOutput>,
        agent9527_extension_api::FunctionCallError,
    > {
