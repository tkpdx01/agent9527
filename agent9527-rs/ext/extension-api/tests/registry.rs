...
use agent9527_extension_api::ApprovalReviewContributor;
...
use agent9527_extension_api::SkillInvocationContributor;
...
use agent9527_extension_api::TurnInputContributor;
use agent9527_extension_api::TurnItemContributor;
use agent9527_extension_api::TurnLifecycleContributor;
use agent9527_extension_api::empty_extension_registry;
use agent9527_protocol::items::HookPromptItem;
        ...
        fragments.extend(
            contributor
                .contribute_turn_context(TurnContextContributionInput {
                    thread_id: agent9527_protocol::ThreadId::default(),
