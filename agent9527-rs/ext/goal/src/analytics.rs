use agent9527_analytics::Agent9527GoalEvent;
use agent9527_analytics::AnalyticsEventsClient;
use agent9527_analytics::GoalEventKind;
...
impl GoalAnalytics {
    ...
    pub(crate) fn cleared(&self, goal: &agent9527_state::ThreadGoal) {
    ...
    fn track(
        ...
        self.client.track_goal_event(Agent9527GoalEvent {
