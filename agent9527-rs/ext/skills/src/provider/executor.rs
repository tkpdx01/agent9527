...
use agent9527_skills::EnvironmentSkillMetadata;
...
impl ExecutorSkillProvider {
    fn list_from_discovery(
        &self,
        snapshot: &agent9527_exec_server::ExecutorCapabilityDiscoverySnapshot,
    ) -> SkillCatalog {
        let mut catalog = SkillCatalog::default();
...
async fn read_bounded_text(
    file_system: &dyn agent9527_exec_server::ExecutorFileSystem,
    path: &PathUri,
    resource: &str,
