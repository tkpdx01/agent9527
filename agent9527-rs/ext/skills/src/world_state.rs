...
use agent9527_core_skills::build_available_skills;
use agent9527_core_skills::render::SkillRenderSideEffects;
...
pub(crate) fn host_skills_world_state_section(
    ...
    let metadata_budget = match metadata_budget {
        SkillMetadataBudget::Tokens(limit) => {
            agent9527_core_skills::SkillMetadataBudget::Tokens(limit)
        }
        SkillMetadataBudget::Characters(limit) => {
            agent9527_core_skills::SkillMetadataBudget::Characters(limit)
        }
    };
