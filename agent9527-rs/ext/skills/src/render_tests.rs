...
use agent9527_core_skills::render_available_skills_body;
use agent9527_extension_api::ContextualUserFragment;
...
fn path_aliases_are_not_used_without_budget_pressure() {
    let root = "/Users/test/.agent9527/plugins/cache/openai-curated/example/hash/skills";
    let catalog = SkillCatalog {
        entries: vec![
...
fn path_aliases_retain_every_skill_under_budget_pressure() {
    let root = "/Users/test/.agent9527/plugins/cache/openai-curated/example/hash1234567890/skills-with-a-very-long-shared-prefix";
    let entries = (0..12)
        .map(|index| {
...
fn singleton_plugin_versions_share_the_marketplace_alias_root() {
    let github_root = "/Users/test/.agent9527/plugins/cache/openai-curated/github/hash123/skills";
    let slack_root = "/Users/test/.agent9527/plugins/cache/openai-curated/slack/hash456/skills";
    let entries = [
    ...
    assert_eq!(
        ...
        vec!["- `r0` = `/Users/test/.agent9527/plugins/cache/openai-curated`".to_string()]
    );
    assert_eq!(
