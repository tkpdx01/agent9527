...
use agent9527_core_skills::SKILLS_INTRO_WITH_ABSOLUTE_PATHS;
use agent9527_core_skills::SkillLoadOutcome;
use agent9527_core_skills::injection::InjectedHostSkillPrompts;
use agent9527_core_skills::loader::MAX_CONCURRENT_ROOT_SCANS;
use agent9527_core_skills::loader::SkillRoot;
use agent9527_core_skills::loader::load_skills_from_roots;
use agent9527_exec_server::LOCAL_FS;
use agent9527_extension_api::ConversationHistory;
...
use agent9527_models_manager::model_info::model_info_from_slug;
...
use agent9527_protocol::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
use agent9527_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
...
use agent9527_skills_extension::SkillProviders;
use agent9527_skills_extension::SkillsExtensionConfig;
use agent9527_skills_extension::catalog::SkillAuthority;
use agent9527_skills_extension::catalog::SkillCatalog;
use agent9527_skills_extension::catalog::SkillCatalogEntry;
use agent9527_skills_extension::catalog::SkillPackageId;
use agent9527_skills_extension::catalog::SkillProviderError;
use agent9527_skills_extension::catalog::SkillReadResult;
use agent9527_skills_extension::catalog::SkillResourceId;
use agent9527_skills_extension::catalog::SkillSearchResult;
use agent9527_skills_extension::catalog::SkillSourceKind;
use agent9527_skills_extension::install;
use agent9527_skills_extension::install_with_providers;
use agent9527_skills_extension::provider::SkillListQuery;
use agent9527_skills_extension::provider::SkillProvider;
use agent9527_skills_extension::provider::SkillProviderFuture;
use agent9527_skills_extension::provider::SkillReadRequest;
use agent9527_skills_extension::provider::SkillSearchRequest;
...
async fn installed_extension_uses_host_service_snapshot() -> TestResult {
    ...
    let skill_path = agent9527_home.join("skills").join("demo").join("SKILL.md");
    ...
    std::fs::remove_dir_all(agent9527_home)?;
    Ok(())
}
...
async fn selected_executor_catalog_follows_step_availability_and_reuses_its_cache() -> TestResult {
    ...
    let available_sections = registry.context_contributors()[0]
        .contribute_world_state(WorldStateContributionInput {
            thread_id: agent9527_protocol::ThreadId::new(),
            turn_id: "turn-1",
...
async fn host_catalog_compacts_shared_paths_under_budget_pressure() -> TestResult {
    let test_root = test_agent9527_home();
...
fn test_agent9527_home() -> PathBuf {
    ...
    std::env::temp_dir().join(format!(
        "agent9527-skills-extension-test-{}-{id}",
        std::process::id(),
    ))
}
