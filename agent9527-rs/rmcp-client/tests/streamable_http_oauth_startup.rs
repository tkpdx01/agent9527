...
use agent9527_rmcp_client::WrappedOAuthTokenResponse;
...
use agent9527_rmcp_client::save_oauth_tokens;
...
async fn refreshes_expired_persisted_token_before_initialize() -> anyhow::Result<()> {
    ...
    Mock::given(method("GET"))
        ...
        .and(header(
            "user-agent",
            concat!("agent9527-mcp-client/", env!("CARGO_PKG_VERSION")),
        ))
    ...
    // Credential storage resolves AGENT9527_HOME from the process environment.
