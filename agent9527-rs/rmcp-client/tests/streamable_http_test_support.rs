...
fn streamable_http_server_bin() -> Result<PathBuf, CargoBinError> {
    agent9527_utils_cargo_bin::cargo_bin("test_streamable_http_server")
}
...
fn init_params() -> InitializeRequestParams {
    ...
    InitializeRequestParams::new(
        ...
        Implementation::new("agent9527-test", "0.0.0-test")
            .with_title("Agent9527 rmcp recovery test"),
    )
...
/// Reads the websocket URL printed by `agent9527 exec-server --listen`.
