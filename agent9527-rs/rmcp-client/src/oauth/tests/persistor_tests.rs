...
const REFRESH_LOCK_CONTENTION_EVENT_TARGET: &str =
    "agent9527_rmcp_client::oauth::refresh_lock::contention";
...
async fn test_context() -> Result<(TempAgent9527Home, MockServer, StoredOAuthTokens)> {
