pub use agent9527_backend_openapi_models::models::ConfigBundleResponse;
pub use agent9527_backend_openapi_models::models::CreditStatusDetails;
pub use agent9527_backend_openapi_models::models::DeliveredConfigToml;
pub use agent9527_backend_openapi_models::models::DeliveredManagedLayers;
pub use agent9527_backend_openapi_models::models::DeliveredRequirementsToml;
pub use agent9527_backend_openapi_models::models::DeliveredTomlFragment;
pub use agent9527_backend_openapi_models::models::PaginatedListTaskListItem;
pub use agent9527_backend_openapi_models::models::PlanType;
pub use agent9527_backend_openapi_models::models::RateLimitReachedKind;
pub use agent9527_backend_openapi_models::models::RateLimitStatusDetails;
pub use agent9527_backend_openapi_models::models::RateLimitStatusPayload;
pub use agent9527_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use agent9527_backend_openapi_models::models::SpendControlLimitDetails;
pub use agent9527_backend_openapi_models::models::TaskListItem;
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct Agent9527WorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<Agent9527WorkspaceMessage>,
}

/// Authenticated Agent9527 user settings used by CLI runtime policy.
#[derive(Clone, Copy, Debug, Default, Deserialize, PartialEq, Eq)]
pub struct Agent9527UserSettingsResponse {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct Agent9527WorkspaceMessage {
    pub message_id: String,
    pub message_type: Agent9527WorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum Agent9527WorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        let response: Agent9527WorkspaceMessagesResponse =
        ...
        assert_eq!(
            response,
            Agent9527WorkspaceMessagesResponse {
                messages: vec![
                    Agent9527WorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: Agent9527WorkspaceMessageType::Headline,
                    ...
                    Agent9527WorkspaceMessage {
                        ...
                        message_type: Agent9527WorkspaceMessageType::Announcement,
                    ...
                    Agent9527WorkspaceMessage {
                        ...
                        message_type: Agent9527WorkspaceMessageType::Unknown,
