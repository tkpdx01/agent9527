...
use agent9527_http_client::build_reqwest_client_with_custom_ca;
use agent9527_http_client::with_chatgpt_cloudflare_cookie_store;
...
impl Client {
    ...
    pub fn from_auth(base_url: impl Into<String>, auth: &Agent9527Auth) -> Result<Self> {
