...
async fn should_skip_bwrap_tests() -> bool {
    ...
    .await
    {
        ...
        Err(Agent9527Err::Sandbox(SandboxErr::Denied { output, .. })) => {
        ...
        Err(Agent9527Err::Sandbox(SandboxErr::Timeout { .. })) => true,
...
fn expect_denied(
    ...
    match result {
        ...
        Err(Agent9527Err::Sandbox(SandboxErr::Denied { output, .. })) => *output,
...
async fn sandbox_reports_agent9527_symlink_build_failure_without_panicking() {
    ...
    {
        Err(Agent9527Err::Sandbox(SandboxErr::Denied { output, .. })) => *output,
        result => panic!(".agent9527 symlink build failure should deny: {result:?}"),
    };
