...
use agent9527_app_server_protocol::RemoteControlDisableParams;
use agent9527_app_server_protocol::RemoteControlDisableResponse;
use agent9527_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<agent9527_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_AGENT9527_HOME: &str = "/tmp/agent9527-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "agent9527_app_server/1.2.3",
                    "agent9527Home": TEST_AGENT9527_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
