...
mod agent9527_tool_config;
mod agent9527_tool_runner;
mod exec_approval;
...
pub use crate::agent9527_tool_config::Agent9527ToolCallParam;
pub use crate::agent9527_tool_config::Agent9527ToolCallReplyParam;
...
const OTEL_SERVICE_NAME: &str = "agent9527_mcp_server";
...
mod tests {
    ...
    async fn mcp_server_builds_otel_provider_with_logs_traces_and_metrics() -> anyhow::Result<()> {
        ...
        let provider = agent9527_core::otel_init::build_provider(
            &config,
            "0.0.0-test",
            Some(OTEL_SERVICE_NAME),
            DEFAULT_ANALYTICS_ENABLED,
