...
use agent9527_core::util::backoff;
...
pub(super) const REMOTE_CONTROL_INSTALLATION_ID_HEADER: &str = "x-agent9527-installation-id";
const REMOTE_CONTROL_SUBSCRIBE_CURSOR_HEADER: &str = "x-agent9527-subscribe-cursor";
...
fn build_remote_control_websocket_request(
    ...
    set_remote_control_header(headers, "x-agent9527-server-id", &enrollment.server_id)?;
