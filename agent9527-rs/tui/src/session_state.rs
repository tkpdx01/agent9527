...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: agent9527_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<agent9527_protocol::openai_models::ReasoningEffort>,
