...
//! "leave the old title alone" or "clear the title Agent9527 last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Agent9527 manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Agent9527 started managing the title.
