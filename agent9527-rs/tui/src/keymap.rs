...
use agent9527_config::types::KeybindingsSpec;
use agent9527_config::types::MAX_FUNCTION_KEY;
...
Set unique keys in `~/.agent9527/config.toml` and retry. \
...
Set a different key in `~/.agent9527/config.toml` and retry. \
See the Agent9527 keymap documentation for supported actions and examples."
                ));
            }
        }
...
mod tests {
    use super::*;
    use agent9527_config::types::KeybindingSpec;
