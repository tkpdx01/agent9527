//! The main Agent9527 TUI chat surface.
//!
...
use crate::version::AGENT9527_CLI_VERSION;
use agent9527_app_server_protocol::AddCreditsNudgeCreditType;
use agent9527_app_server_protocol::AddCreditsNudgeEmailStatus;
use agent9527_app_server_protocol::Agent9527ErrorInfo as AppServerAgent9527ErrorInfo;
...
use agent9527_app_server_protocol::CommandExecutionSource as ExecCommandSource;
use agent9527_app_server_protocol::CreditsSnapshot;
...
use agent9527_app_server_protocol::ModelVerification as AppServerModelVerification;
use agent9527_app_server_protocol::RateLimitReachedType;
...
use agent9527_app_server_protocol::SkillMetadata as ProtocolSkillMetadata;
use agent9527_app_server_protocol::SkillsListResponse;
use agent9527_app_server_protocol::ThreadGoal as AppThreadGoal;
use agent9527_app_server_protocol::ThreadGoalStatus as AppThreadGoalStatus;
...
use agent9527_config::ConstraintResult;
...
use agent9527_core_skills::model::SkillMetadata;
use agent9527_features::FEATURES;
use agent9527_features::Feature;
#[cfg(test)]
use agent9527_git_utils::CommitLogEntry;
use agent9527_git_utils::current_branch_name;
use agent9527_git_utils::get_git_repo_root;
use agent9527_git_utils::local_git_branches;
use agent9527_git_utils::recent_commits;
use agent9527_otel::RuntimeMetricsSummary;
use agent9527_otel::SessionTelemetry;
use agent9527_plugin::PluginCapabilitySummary;
use agent9527_protocol::ThreadId;
use agent9527_protocol::account::PlanType;
use agent9527_protocol::approvals::GuardianAssessmentAction;
use agent9527_protocol::approvals::GuardianAssessmentDecisionSource;
use agent9527_protocol::approvals::GuardianAssessmentEvent;
use agent9527_protocol::approvals::GuardianAssessmentStatus;
...
use agent9527_protocol::plan_tool::PlanItemArg as UpdatePlanItemArg;
use agent9527_protocol::plan_tool::StepStatus as UpdatePlanItemStatus;
...
use agent9527_utils_cli::resume_hint;
...
const MEMORIES_DOC_URL: &str = "https://developers.openai.com/agent9527/memories";
...
use agent9527_file_search::FileMatch;
...
use agent9527_utils_approval_presets::ApprovalPreset;
use agent9527_utils_approval_presets::builtin_approval_presets;
use chrono::Local;
...
pub(crate) struct ChatWidgetInit {
    ...
    pub(crate) has_agent9527_backend_auth: bool,
    pub(crate) model_catalog: Arc<ModelCatalog>,
    pub(crate) feedback: agent9527_feedback::Agent9527Feedback,
...
/// and by sending requests back to agent9527-core.
///
...
pub(crate) struct ChatWidget {
    ...
    agent9527_op_target: Agent9527OpTarget,
    ...
    has_agent9527_backend_auth: bool,
    ...
    agent9527_rate_limit_reached_type: Option<RateLimitReachedType>,
    agent9527_spend_control_reached: Option<bool>,
...
fn request_permissions_from_params(
    params: agent9527_app_server_protocol::PermissionsRequestApprovalParams,
...
impl ChatWidget {
    ...
    pub(crate) fn open_feedback_consent(&mut self, category: crate::app_event::FeedbackCategory) {
        ...
        let include_windows_sandbox_log =
            agent9527_windows_sandbox::current_log_file_path_for_agent9527_home(
                &self.config.agent9527_home,
            )
            .is_file();
    ...
    /// Forward a command directly to agent9527.
        ...
        T: Into<AppCommand>,
    {
        ...
        match &self.agent9527_op_target {
            Agent9527OpTarget::Direct(agent9527_op_tx) => {
                crate::session_log::log_outbound_op(&op);
                if let Err(e) = agent9527_op_tx.send(op) {
                    tracing::error!("failed to submit op: {e}");
                    return false;
                }
            }
            Agent9527OpTarget::AppEvent => {
                self.app_event_tx.send(AppEvent::Agent9527Op(op));
            }
        }
        true
    }
