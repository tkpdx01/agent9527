//! Shared implementation for `agent9527 archive`, `agent9527 delete`, and `agent9527 unarchive`.
//!
...
async fn start_app_server_for_archive_command(
    ...
    let agent9527_home = find_agent9527_home().wrap_err("failed to find Agent9527 home")?;
    ...
    let default_daemon = if explicit_remote_endpoint.is_none() && reuse_implicit_local_daemon {
        super::maybe_probe_default_daemon_socket(agent9527_home.as_path()).await
    } else {
        None
    };
