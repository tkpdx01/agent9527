//! Built-in pet catalog ported from the Agent9527 App avatar catalog.
...
pub(super) const BUILTIN_PETS: &[BuiltinPet] = &[
    BuiltinPet {
        id: "agent9527",
        display_name: "Agent9527",
        description: "The original Agent9527 companion",
        spritesheet_file: "agent9527-spritesheet-v4.webp",
    },
    BuiltinPet {
        id: "dewey",
        display_name: "Dewey",
