//! Ambient terminal rendering for the Agent9527 companion.
//!
...
impl AmbientPet {
    ...
    /// AGENT9527_HOME cache, and records the terminal protocol support snapshot used
...
mod tests {
    ...
    #[test]
    fn notification_labels_match_agent9527_app_vocabulary() {
