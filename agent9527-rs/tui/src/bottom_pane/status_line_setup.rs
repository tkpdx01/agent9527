...
impl StatusLineItem {
    ...
    pub(crate) fn description(self) -> &'static str {
        match self {
            ...
            StatusLineItem::Agent9527Version => "Agent9527 application version",
    ...
    pub(crate) fn preview_item(self) -> StatusSurfacePreviewItem {
        match self {
            ...
            StatusLineItem::Agent9527Version => StatusSurfacePreviewItem::Agent9527Version,
    ...
    fn setup_view_snapshot_uses_runtime_preview_values() {
        ...
        let view = StatusLineSetupView::new(
            ...
            StatusSurfacePreviewData::from_iter([
                (
                    StatusLineItem::ModelName.preview_item(),
                    "gpt-5-agent9527".to_string(),
                ),
                (
                    StatusLineItem::CurrentDir.preview_item(),
                    "~/agent9527-rs".to_string(),
                ),
                (
