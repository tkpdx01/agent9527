...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "agent9527",
            ...
            StatusSurfacePreviewItem::Agent9527Version => "0.0.0",
            ...
            StatusSurfacePreviewItem::Model => "gpt-5.2-agent9527",
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.2-agent9527 medium",
