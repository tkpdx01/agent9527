...
use agent9527_utils_fuzzy_match::fuzzy_match;
...
mod tests {
    ...
    #[test]
    fn usage_command_exact_lookup_is_removed_with_account_authentication() {
        assert_eq!(find_builtin_command("usage", all_enabled_flags()), None);
    }
