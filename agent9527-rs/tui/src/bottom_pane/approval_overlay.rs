...
use agent9527_app_server_protocol::FileSystemAccessMode;
use agent9527_app_server_protocol::FileSystemPath;
use agent9527_app_server_protocol::FileSystemSandboxEntry;
use agent9527_app_server_protocol::FileSystemSpecialPath;
use agent9527_app_server_protocol::McpServerElicitationAction;
use agent9527_app_server_protocol::NetworkApprovalContext;
use agent9527_app_server_protocol::NetworkApprovalProtocol;
    ...
    available_decisions
        ...
        .filter_map(|decision| match decision {
            ...
            CommandExecutionApprovalDecision::Cancel => Some(ApprovalOption {
                label: approval_text(
                    "approval-tell-agent9527",
                    "No, and tell Agent9527 what to do differently",
                ),
...
mod tests {
    ...
    use agent9527_app_server_protocol::ExecPolicyAmendment;
    use agent9527_app_server_protocol::NetworkApprovalProtocol;
    use agent9527_app_server_protocol::NetworkPolicyAmendment;
    ...
    fn network_exec_options_use_expected_labels_and_hide_execpolicy_amendment() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "No, and tell Agent9527 what to do differently".to_string(),
            ]
        );
    }
    ...
    fn exec_history_cell_wraps_with_two_space_indent() {
        ...
        let rendered: Vec<String> = lines
            ...
            .collect();
        let expected = vec![
            "✔ You approved agent9527 to".to_string(),
    ...
    fn network_access_command_history_uses_target_without_structured_context() {
        ...
        assert_eq!(
            ...
            vec![
                "✔ You approved agent9527 network access to https://example.com:8443 this time"
                    .to_string(),
            ]
        );
    }
