...
pub(crate) const PACKAGE_URL: &str = "https://registry.npmjs.org/@openai%2fagent9527";
    ...
    fn version_json(version: &str) -> serde_json::Value {
        serde_json::json!({
            "dist": {
                ...
                "tarball": format!("https://registry.npmjs.org/@tkpdx01/agent9527/-/agent9527-{version}.tgz"),
            }
        })
    }
