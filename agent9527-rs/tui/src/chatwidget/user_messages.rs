...
use agent9527_app_server_protocol::TextElement as AppServerTextElement;
...
use agent9527_utils_plugins::mention_syntax::PLUGIN_TEXT_MENTION_SIGIL;
        ...
        .filter_map(|item| match item {
            ...
            UserInput::Mention { name, path } => {
                ...
                let mention = if let Some(plugin_id) = plugin_id {
                    ...
                    agent9527_connectors::metadata::connector_mention_slug_from_name(name)
                } else {
                    name.clone()
                };
