...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: agent9527_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, agent9527_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                agent9527_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                agent9527_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                agent9527_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                agent9527_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                agent9527_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                agent9527_app_server_protocol::GuardianRiskLevel::Low => {
                    agent9527_protocol::approvals::GuardianRiskLevel::Low
                }
                agent9527_app_server_protocol::GuardianRiskLevel::Medium => {
                    agent9527_protocol::approvals::GuardianRiskLevel::Medium
                }
                agent9527_app_server_protocol::GuardianRiskLevel::High => {
                    agent9527_protocol::approvals::GuardianRiskLevel::High
                }
                agent9527_app_server_protocol::GuardianRiskLevel::Critical => {
                    agent9527_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    agent9527_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        agent9527_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    agent9527_app_server_protocol::GuardianUserAuthorization::Low => {
                        agent9527_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    agent9527_app_server_protocol::GuardianUserAuthorization::Medium => {
                        agent9527_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    agent9527_app_server_protocol::GuardianUserAuthorization::High => {
                        agent9527_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                agent9527_app_server_protocol::AutoReviewDecisionSource::Agent => {
