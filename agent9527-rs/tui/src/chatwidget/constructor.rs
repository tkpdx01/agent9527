...
impl ChatWidget {
    pub(crate) fn new_with_app_event(common: ChatWidgetInit) -> Self {
        Self::new_with_op_target(common, Agent9527OpTarget::AppEvent)
    }
    ...
    pub(super) fn new_with_op_target(
        ...
        let mut widget = Self {
            ...
            agent9527_rate_limit_reached_type: None,
            agent9527_spend_control_reached: None,
        ...
        widget
            .bottom_pane
            .set_token_activity_command_enabled(widget.has_agent9527_backend_auth);
