...
use agent9527_utils_plugins::mention_syntax::TOOL_MENTION_SIGIL;
...
pub(crate) fn find_app_mentions(
    ...
    for app in apps.iter().filter(|app| is_app_mentionable(app)) {
        let slug = agent9527_connectors::metadata::connector_mention_slug(app);
