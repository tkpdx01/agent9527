...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Agent9527",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit Agent9527",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how Agent9527 performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for Agent9527",
            ...
            SlashCommand::Permissions => "choose what Agent9527 is allowed to do",
            ...
            SlashCommand::Logout => "log out of Agent9527",
    ...
    /// User-visible description resolved through the active language pack.
    pub fn localized_description(self) -> String {
        let key = format!("slash-{}-description", self.command());
    ...
    fn is_visible(self) -> bool {
        if !product_policy::account_authentication_enabled()
            && matches!(self, SlashCommand::Usage | SlashCommand::Logout)
        {
            return false;
        }
...
mod tests {
    ...
    #[test]
    fn account_commands_are_not_exposed() {
        let commands = super::built_in_slash_commands();
        assert!(
            !commands
                .iter()
                .any(|(_, command)| matches!(command, SlashCommand::Usage | SlashCommand::Logout))
        );
    }
