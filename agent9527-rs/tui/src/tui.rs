...
/// Restore the terminal after Agent9527 is exiting.
///
...
impl Tui {
    pub(crate) fn new(
        ...
        let is_zellij = agent9527_terminal_detection::terminal_info().is_zellij();
    ...
    /// terminal modes and stderr while keeping raw mode enabled, then re-applies Agent9527 TUI modes
