...
use agent9527_app_server_protocol::AuthMode as ApiAuthMode;
...
fn onboarding_request_id() -> agent9527_app_server_protocol::RequestId {
    agent9527_app_server_protocol::RequestId::String(Uuid::new_v4().to_string())
}
...
pub(super) async fn cancel_login_attempt(
    ...
    let _ = request_handle
        .request_typed::<agent9527_app_server_protocol::CancelLoginAccountResponse>(
...
impl AuthModeWidget {
            ...
            Line::from(vec![
                ...
                localizer
                    .text("onboarding-paid-plan-intro", None, || {
                        "Sign in with ChatGPT to use Agent9527 as part of your paid plan"
                            .to_string()
                    })
                    .into(),
            ]),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant Agent9527".into(),
            Line::from(vec![
                "  For more details see the ".into(),
                crate::terminal_hyperlinks::osc8_hyperlink(
                    "https://developers.openai.com/agent9527/security",
                    "Agent9527 docs",
                )
                .underlined(),
            ])
            .dim(),
            "".into(),
            "  Agent9527 can make mistakes".into(),
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Agent9527 will use usage-based billing with your API key.".into(),
        ];
...
mod tests {
    ...
    const PRODUCTION_LENGTH_AUTH_URL: &str = concat!(
        ...
        "agent9527_cli_simplified_flow=true&",
        "state=8cHjQ4nVx2Yp7Lm9Rk3Wf6Ta1Bs5Du0Ei4Go7Nz2PqM&",
        "originator=agent9527_cli_rs"
    );
    ...
    async fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let config = ConfigBuilder::default()
            .agent9527_home(agent9527_home_path.clone())
            .build()
            .await
            .unwrap();
        ...
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            environment_manager: Arc::new(
                agent9527_app_server_client::EnvironmentManager::default_for_tests(),
            ),
