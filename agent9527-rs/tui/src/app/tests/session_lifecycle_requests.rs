...
async fn start_recording_app_server(
    ...
    let embedded = crate::start_embedded_app_server(
        agent9527_arg0::Arg0DispatchPaths::default(),
        config.clone(),
        Vec::new(),
        agent9527_config::LoaderOverrides::default(),
        /*strict_config*/ false,
        agent9527_config::CloudConfigBundleLoader::default(),
    ...
    .await?;
    let agent9527_home = config.agent9527_home.display().to_string();
                        ...
                        .send(Message::Text(
                            serde_json::to_string(&JSONRPCMessage::Response(JSONRPCResponse {
                                ...
                                result: serde_json::json!({
                                    "userAgent": "agent9527-tui-test",
                                    "agent9527Home": agent9527_home,
                                }),
                            }))?
                            .into(),
                        ))
