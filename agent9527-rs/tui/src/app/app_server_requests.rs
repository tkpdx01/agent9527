...
mod tests {
    ...
    use agent9527_app_server_protocol::McpElicitationObjectType;
    use agent9527_app_server_protocol::McpElicitationSchema;
    ...
    use agent9527_app_server_protocol::PermissionGrantScope;
    use agent9527_app_server_protocol::PermissionsRequestApprovalParams;
    use agent9527_app_server_protocol::PermissionsRequestApprovalResponse;
    use agent9527_app_server_protocol::RequestId as AppServerRequestId;
    use agent9527_app_server_protocol::ServerRequest;
    use agent9527_app_server_protocol::ToolRequestUserInputAnswer;
    ...
    fn rejects_permissions_with_paths_that_cannot_be_localized() {
        ...
        let permissions = agent9527_app_server_protocol::RequestPermissionProfile {
            network: None,
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: agent9527_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: agent9527_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: agent9527_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        glob_scan_max_depth: None,
                        entries: Some(vec![
                            agent9527_app_server_protocol::FileSystemSandboxEntry {
                                path: agent9527_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path).into(),
                                },
                                access: agent9527_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            agent9527_app_server_protocol::FileSystemSandboxEntry {
                                path: agent9527_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path).into(),
                                },
                                access: agent9527_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: agent9527_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason:
                        agent9527_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
