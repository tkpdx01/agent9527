...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Agent9527 is rebuilding normal terminal scrollback, not an
...
use agent9527_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
