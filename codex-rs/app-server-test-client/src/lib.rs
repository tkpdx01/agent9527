...
pub async fn run() -> Result<()> {
    ...
    match command {
        ...
        CliCommand::ThreadIncrementElicitation { thread_id } => {
            ...
            let url =
                resolve_shared_websocket_url(codex_bin, url, "thread-increment-elicitation")?;
        ...
        CliCommand::ThreadDecrementElicitation { thread_id } => {
            ...
            let url =
                resolve_shared_websocket_url(codex_bin, url, "thread-decrement-elicitation")?;
        ...
        CliCommand::PluginAnalyticsSmoke {
            ...
            let codex_bin =
                codex_bin.context("plugin-analytics-smoke requires --codex-bin")?;
        ...
        CliCommand::PluginAnalyticsMutationSmoke {
            ...
            let codex_bin = codex_bin
                .context("plugin-analytics-mutation-smoke requires --codex-bin")?;
        ...
        CliCommand::PluginRemoteUninstall {
            ...
            if url.is_some() {
                bail!(
                    "plugin-remote-uninstall requires --codex-bin and does not support --url"
                );
            }
            let codex_bin =
                codex_bin.context("plugin-remote-uninstall requires --codex-bin")?;
