//! Codex distribution policy kept separate from upstream feature behavior.
...
pub const EXTERNAL_API_ONLY_ENV: &str = "CODEX_EXTERNAL_API_ONLY";
...
pub const EXTERNAL_PROVIDER_REQUIRED_MESSAGE: &str = "Codex only supports external API providers. Configure `model_provider` with `requires_openai_auth = false`, or set CODEX_API_BASE_URL, CODEX_API_KEY, and CODEX_MODEL.";
