...
impl PluginRequestProcessor {
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                >((
                    ...
                    outcome
                        ...
                        .into_iter()
                        .map(
                            |err| codex_app_server_protocol::MarketplaceLoadErrorInfo {
    ...
    async fn remote_plugin_install_response(
        ...
        let validated_bundle =
            codex_core_plugins::remote_bundle::validate_remote_plugin_bundle(
                &remote_plugin_id,
                &actual_remote_marketplace_name,
                &remote_plugin_name,
    ...
    async fn remote_plugin_uninstall_response(
        ...
        let uninstall_target =
            codex_core_plugins::remote::resolve_remote_plugin_uninstall_target(
                &remote_plugin_service_config,
                auth.as_ref(),
                &plugin_id,
            )
