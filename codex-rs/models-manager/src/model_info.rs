...
const DEFAULT_PERSONALITY_HEADER: &str = "You are Codex, a coding agent using the configured model. You and the user share the same workspace and collaborate to achieve the user's goals.";
