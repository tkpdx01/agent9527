...
use codex_models_manager::MODEL_BALANCED;
use codex_models_manager::MODEL_FLASH;
...
mod tests {
    ...
    async fn configured_bedrock_catalog_only_allows_default_service_tier() {
        let mut configured_model = codex_models_manager::upstream_bundled_models_response()
