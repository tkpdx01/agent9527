...
PACKAGE_VARIANTS: dict[str, PackageVariant] = {
    "agent9527": PackageVariant(
        name="agent9527",
        cargo_bin="agent9527",
        executable_stem="agent9527",
    ),
    "agent9527-app-server": PackageVariant(
        name="agent9527-app-server",
        cargo_bin="agent9527-app-server",
        executable_stem="agent9527-app-server",
    ),
}
