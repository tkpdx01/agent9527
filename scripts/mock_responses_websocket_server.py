...
async def _handle_connection(
    ...
    *,
    ...
    # Request 1: provoke a function call (mirrors `agent9527-rs/core/tests/suite/agent_websocket.rs`).
...
start agent9527 with `agent9527 --profile localapi_ws`
""")
    sys.stdout.flush()
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Mock a minimal Responses API WebSocket endpoint for the `test_agent9527` flow.\n"
