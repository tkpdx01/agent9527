---
name: test-tui
description: Guide for testing Agent9527 TUI interactively
---

You can start and use Agent9527 TUI to verify changes.
...
Use `just agent9527` target to run - `just agent9527 -c ...`
