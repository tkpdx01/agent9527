...
_WORKSPACE_ROOT_MARKER = "//agent9527-rs/utils/cargo-bin:repo_root.marker"

def agent9527_e2e_benchmark(name, binaries = [], data = [], deps = []):
    ...
    workspace_root_test(
        ...
        visibility = ["//agent9527-rs:__pkg__"],
