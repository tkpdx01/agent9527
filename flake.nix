{
  description = "Development Nix flake for OpenAI Agent9527 CLI";
  ...
  outputs = { self, nixpkgs, rust-overlay, ... }:
    let
      ...
      cargoToml = builtins.fromTOML (builtins.readFile ./agent9527-rs/Cargo.toml);
    ...
    in
    {
      packages = forAllSystems (system:
        let
          ...
          agent9527-rs = pkgs.callPackage ./agent9527-rs {
            inherit version;
        ...
        in
        {
          agent9527-rs = agent9527-rs;
          default = agent9527-rs;
        }
      );
